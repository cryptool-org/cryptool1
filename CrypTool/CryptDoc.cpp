...
BEGIN_MESSAGE_MAP(CCryptDoc, CAppDocument)
	...
	ON_COMMAND(ID_ANALYSE_SYMCLASSIC_ADFGVX, OnAnalyseSymmclassicAdfgvx)
	...
	ON_COMMAND(ID_ANALYSE_SYMCLASSIC_CIPHERTEXTONLY_SOLITAIRE, OnAnalyseSymmclassicCiphertextolySolitaire)
