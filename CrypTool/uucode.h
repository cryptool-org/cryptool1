...
#define UU_DECODE_ILLEGAL_CHARACTER -2
#define UU_DECODE_MISSING_CHAR -3
#define UU_FILE_OPEN_ERROR -4
#define UU_FILE_WRITE_ERROR -5
#define UU_DECODE_LB_DIFFERS_TOSHORT -6
#define UU_DECODE_LB_DIFFERS_TOLONG -7
#define UU_DECODE_MISSING_FN -8
#define UU_DECODE_MISSING_END -9
#define UU_DECODE_MISSING_NL_BEFORE_END -10
#define UU_DECODE_MISSING_NL_AFTER_END -11
 ...
 *    0 -> correct encoding
 *
 * Der Eingabebuffer ist fest definiert auf 4500 [ Vielfaches von 45(Der Eingabezeilenlänge)]. Ausgabebuffer entsprechend angepasst.
 *
 *
 */
extern __w64 int UUEncode(
 ...
 */
extern ssize_t UUDecode(
	const char *_in,size_t inlen,
	char *_out,size_t outlen,
	u_int32_t *state /*=NULL*/,ssize_t *outfill,ssize_t *indec, BOOL lastBlock,int *lines);
