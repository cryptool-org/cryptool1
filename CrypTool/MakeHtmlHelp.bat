...
echo Create %HLP%\hid_load_readme.html from ..\setup\template-%LANG%\ReadMe-%LANG%.txt and %HLP%\hid_load_readme.html.in
perl readme.pl -o %HLP%\hid_load_readme.html -i ..\setup\template-%LANG%\ReadMe-%LANG%.txt -t %HLP%\hid_load_readme.html.in
