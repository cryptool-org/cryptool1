...
REM -- Create readme.html from readme.html.in
echo Create %HLP%\readme.html from ..\setup\template-%LANG%\ReadMe-%LANG%.txt and %HLP%\readme.html.in
readme.pl -o %HLP%\readme.html -i ..\setup\template-%LANG%\ReadMe-%LANG%.txt -t %HLP%\readme.html.in
