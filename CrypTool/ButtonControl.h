...
const ButtonResourceStruct BitmapResources[] = 
{
	...
	{	IDC_EXCHANGEARROWS,			"IDB_DH_ARROWS_R_U",	"IDB_DH_ARROWS_R_D",	"IDB_DH_ARROWS_R_F",	"IDB_DH_ARROWS_R_X",	"IDB_DH_ARROWS_G_U",	"IDB_DH_ARROWS_G_D",	"IDB_DH_ARROWS_G_F",	"IDB_DH_ARROWS_G_X" },
