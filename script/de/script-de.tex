% $Id$
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%% Add lengthy comments only into the German version! %%%%%%%%%%
...
% Statt T1 als Package zu inkludieren, nur die benötigten Sonderzeichen definiert.
...
% TODO: Warum nach dem Cover eine leere Seite und auf der von \maketitle
%       erstellten 3. Seite die Seitennummer II ?  Beides ist akzeptabel.
% TODO: Warum beginnt er auf der 4. Seite wieder mit der Seite römisch I ?
