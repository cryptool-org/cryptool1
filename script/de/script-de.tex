...
% -------------
% \usepackage{xstring,xifthen}  %BE_2016Jun: %% be_todo: To use \StrSubstitute{abcde}{d}{D} (together with hyperref)
\usepackage{xstring}  %BE_2016Jun: %% be_todo: To use \StrSubstitute{abcde}{d}{D}  (together with hyperref)
...
%   Copyright \textcopyright{} 1998--2016 Bernhard Esslinger and the  %%  Geht beides.
...
\begin{bibunit}[plain]
\nocite{*}
\renewcommand{\bibname}{Literaturverzeichnis über alle Kapitel}
\putbib[../de/references]
\addcontentsline{toc}{chapter}{Literaturverzeichnis über alle Kapitel}
\end{bibunit}
...
\renewcommand{\bibname}{Literaturverzeichnis über alle Kapitel (sortiert nach Autoren)}
\putbib[../de/references]
\addcontentsline{toc}{chapter}{Literaturverzeichnis über alle Kapitel (sortiert nach Autoren)}
\end{bibunit}
...
%     Per neu zu def \indexalso neue Zeile am Ende von Entry 1, das auf Entry 2 verweist.
