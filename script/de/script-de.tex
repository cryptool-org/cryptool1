...
\author{ %
	{\LARGE (c) Prof.\ Bernhard Esslinger (Mitautor und Herausgeber)} \\
	\vspace{5pt}
	{\LARGE und das CrypTool Entwickler-Team, 1998-2010} \\
	\vspace{5pt}
	{\LARGE Frankfurt am Main} \\*[1ex]
	\vspace{5pt}
...
\vspace{30pt}
\begin{itemize}
  \item Alle Beispiel wurden mit Sage v 4.2.1 (Release Date 2009-11-14) getestet.
