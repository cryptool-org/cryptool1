...
\newfloat{ctsquotes}{!ht}{loc}[chapter]   % ctsQuotes-from-Books
\floatname{ctsquotes}{Verzeichnis der Zitate}
...
\author{ %
	...
	{\LARGE und das CrypTool Entwickler-Team, 1998-2012}\\[5pt]
...
\chapter{Anhang}
    \begin{itemize}
      ...
      \item[4] \hyperlink{appendix-movies}{Filme und belletristische
                          Literatur mit Bezug zur Kryptographie, Bücher
                          mit Sammlungen einfacher Verfahren für Kinder}
      \item[5] \hyperlink{appendix-Learn-NT}
                         {Lernprogramm Elementare Zahlentheorie}
      \item[6] \hyperlink{appendix-using-sage}
                         {Kurzeinführung in das Computer-Algebra-System Sage}
      \item[7] \hyperlink{appendix-authors}{Autoren des CrypTool-Skripts}
    \end{itemize}
...
% Wenn das aufgerufen, fehlen die Programmbeispiele unter "Verzeichnis der Sage-Bsp"
% und unter zitate-Verzeichnis steht eine lange undefinierte Liste.
% TODOTODO (Joerg) klären
%\clearpage\phantomsection
%\addcontentsline{toc}{chapter}{Verzeichnis der Zitate}
%\listof{ctsquotes}{Verzeichnis der Zitate}
%\index{Zitate}
