...
\index{Hashfunktion}
Eine kryptographische \index{Hashfunktion} {\em Hashfunktion}\footnote{%
...
Hashwert zu finden\index{Kollision}. 
...
gezeigt haben (zum Beispiel \index{SHA-1} SHA-­1\footnote{%
SHA-1 \index{SHA-1} ist eine in FIPS 180-1, ANSI X9.30 Part 2 und
...
M"oglichkeit von Geburtstagsangriffen:\index{Geburtstagsangriff}
\index{Kollision}
...
Mit CrypTool\index{CrypTool} v1.3.04 k"onnen Sie den Geburtstagsangriff
\index{Geburtstagsangriff} auf digitale Signaturen nachvollziehen: \\
...
% --------------------------------------------------------------------------
\subsubsection{Die Impersonalisierungsattacke} \index{Impersonalisierungsattacke} \label{Impersonalisierungsattacke}
...
Jeder Teilnehmer, der sich per \index{X.509} X.509-Zertifikat \cite{X.509} die
Zugeh"origkeit seines "offentlichen Schl"ussels zu seiner realen Person
best"atigen lassen m"ochte, wendet sich an eine sogenannte \index{Certification
Authority (CA)} Certification Authority (CA). Dieser beweist er seine
Identit"at (etwa durch Vorlage seines Personalausweises). Anschlie"send stellt
die CA ihm ein elektronisches Dokument (Zertifikat) aus, in dem im wesentlichen
die Namen des Zertifikatnehmers und der CA, der "offentliche Schl"ussel des
Zertifikatnehmers und der G"ultigkeitszeitraum des Zertifikats vermerkt sind.
Die CA unterzeichnet das Zertifikat anschlie"send mit ihrem geheimen
Schl"ussel.
