...
Die Veröffentlichung von Details zu den Resultaten der
chinesischen Kryptologen wurde bisher nur angekündet: Nach ihren 
Angaben kann man
Kollisionen von SHA-1 mit einem Arbeitsaufwand von $2^{69}$ finden.
Damit wäre gezeigt, dass SHA-1 kryptographische Schwächen besitzt, 
da die Konstruktion von SHA-1 an sich einen Mindestarbeitsaufwand 
für die Kollisionssuche von etwa $2^{80}$ gewährleisten sollte.
...
Das NIST hat schon vor Bekanntwerden der neuen Ergebnisse angekündigt,
SHA-1 in den näch"-sten Jahren auslaufen zu lassen. Es ist daher zu
empfehlen, für neue Produkte zur Erstellung von Sig"-naturen SHA-1 nicht
mehr zu verwenden.
...
sieht folgendermaßen aus:\\ Anstatt das eigentliche Dokument zu signieren,
