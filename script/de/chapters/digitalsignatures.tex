...
muss ein Schlüsselpaar besitzen. Er benutzt seinen geheimen Schlüssel,
...
Schlüssel abzuleiten\footnote{%
Mit CrypTool\index{CrypTool} können Sie ebenfalls digitale Signaturen
erzeugen und prüfen: \\
in den Untermenüs des Hauptmenüpunktes 
...
entscheidenden Nachteil: Die Signatur ist ungefähr genauso lang wie das
...
Kryptographisch sichere Hashfunktionen erfüllen folgende Anforderungen
...
(zum Beispiel \index{SHA-1} SHA-1\footnote{%
  ...
  SHA bedeutet ``Secure Hash Algorithm'' und wird häufig benutzt, z.B. 
  mit DSA, RSA oder ECDSA.\\
  Der aktuelle Standard \cite{FIPS180-3} definiert vier sichere Hashverfahren
  ...
  Mit CrypTool\index{CrypTool} können Sie den Geburtstagsangriff
...
gerückt, denn ähnliche Aufwände wurde in der Vergangenheit schon realisiert (s.\
...
SHA-2 Familie \cite{FIPS180-3} bietet stärkere Verfahren.  Um den neuen
Erkenntnisse in der Kryptoanalyse von Hashfunktionen Rechnung zu tragen hat das
NIST 2008 einen Wettbewerb gestartet, in dem eine neue Hashfunktion ``SHA-3''
ausgewählt werden
soll.\footnote{\url{http://csrc.nist.gov/groups/ST/hash/sha-3/}} Der Wettbewerb
soll im Jahr 2012 enden.
...
sieht folgendermaßen aus:\footnote{% 
Vergleiche auch:\\
...
Authentizität öffentlicher Schlüssel garantieren kann. Die am weitesten
...
\bibitem[FIPS180-3]{FIPS180-3} U.S. Department of Commerce/N.I.S.T. ,
    \index{FIPS180-3} \\
...
\bibitem[McDonald2009]{McDonald2009} Cameron McDonald, Philip Hawkes, Josef Pieprzyk, 
    \index{McDonald 2009} \\
...
\bibitem[Wang2005]{Wang2005} Xiaoyun Wang, Yiqun Yin, Hongbo Yu, 
    \index{Wang 2005} \\
    {\em Finding Collisions in the Full SHA-1}, \\
    Advances in Cryptology-Crypto 2005, LNCS 3621: 17-36, 2005.

\bibitem[Wang2005b]{Wang2005b}  Xiaoyun Wang, Andrew Yao and Frances Yao, 
    \index{Wang 2005} \\
