...
Mit CT1\index{CrypTool 1} können Sie ebenfalls digitale Signaturen
erzeugen und prüfen: \\
...
Ebenso können mit JCT\index{JCrypTool} (in der Standard- und der
Funktions-Perspektive) unterschiedliche Arten elektronischer Signaturen
erzeugt werden.
} 
folgendermaßen aus: \\
...
(zum Beispiel \index{SHA-1} SHA-1\footnote{%
  ...
  SHA bedeutet \glqq Secure Hash Algorithm'' und wird häufig benutzt, z.B. 
  ...
  Mit CT1\index{CrypTool 1} können Sie den Geburtstagsangriff
  ...
  CT2\index{CrypTool 2} enthält einen MD5-Kollisionsgenerator.
  } 
...
das NIST 2008 einen Wettbewerb gestartet: Als neue Hashfunktion \glqq SHA-3''
wurde im Oktober 2012 Keccak\index{Keccak} verkündet.\footnote{%
