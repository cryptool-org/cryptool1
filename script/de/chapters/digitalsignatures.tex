...
in den Untermen"us des Hauptmen"upunktes \glqq Digitale Signaturen'' oder \\
per \glqq Einzelverfahren \textbackslash RSA-Demo \textbackslash Signaturdemo'' .
}
.
...
Performance-Gr"unden\index{Performance} benutzt man eine kryptographische Hashfunktion
\footnote{%
%xxxxxxxxxx Menüeinträgsbezeichnungen ok?
Hashfunktionen sind in CrypTool\index{CrypTool} v1.3.04 an mehreren Stellen implementiert: \\
in dem Men"u \glqq Einzelverfahren \textbackslash Hashwerte'' haben Sie die M"oglichkeit
...
\cite[S.~490]{5Schneier1996}, dass die Operationen des DSA dazu geeignet
