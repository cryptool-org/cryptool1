...
\item aufgrund von gezielt gesuchten Hashwertkollisionen\index{Kollisionen}
...
Sichere Hashverfahren berechnen eine komprimierte Representation elektronischer
Daten (Message).
...
Hashwert zu finden\index{Kollisionen}. 
...
\index{Geburtstagsangriff} auf auf digitale Signaturen nachvollziehen: \\
