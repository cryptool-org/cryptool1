...
und asymmetrischen {\em Verschl"usselung}. Ein gro"ser Teil des
Skripts ist dem faszinierenden Thema der {\em Primzahlen} gewidmet.
Anhand vieler Beispiele bis hin zum {\em RSA-Verfahren} wird in die
{\em modulare Arithmetik} und die {\em elementare Zahlentheorie} eingef"uhrt.
Danach erhalten Sie Einblicke in die mathematischen Ideen
hinter der {\em modernen Kryptographie}.

Ein weiteres Kapitel widmet sich kurz den {\em digitalen Signaturen} ---
sie sind unverzichtbarer Bestandteil von E-Business-Anwendungen.
Das letzte Kapitel stellt {\em Elliptische Kurven} vor: sie sind eine
...
Die {\em Autoren\/} Bernhard Esslinger, Matthias B"uger, 
...
und Karlsruhe, insbesondere bei Dr. Peer Wichmann vom 
...
\vskip + 7 pt \noindent
Die Ansprechpartner f"ur dieses kostenlose Open Source-Tool sind 
in der zum CrypTool-Paket dazugeh"orenden Readme-Datei genannt.
}
