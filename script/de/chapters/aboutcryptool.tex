...
Die Kapitel wurden reichlich mit Fußnoten versehen, in denen auch darauf verwiesen
wird, wo man die beschriebenen Funktionen in den verschiedenen CrypTool-Programmen 
findet.
...
(siehe Anhang \ref{s:appendix-menu-overview-CT1}, \ref{s:appendix-template-overview-CT2} und \ref{s:appendix-function-overview-JCT}) einen schnellen Überblick
