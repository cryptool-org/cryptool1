...
% \makeatletter \renewcommand{\thepage}{\csname @roman\endcsname \c@page} \makeatother
% REMOVED, because it caused missing index entries
% BE_2016-03-16: Nahm dies ohne ~ nach "page" raus. Scheint nichts zu ändern?

\addcontentsline{toc}{chapter}{Überblick über den Inhalt des CrypTool-Buchs}
\chapter*{Überblick über den Inhalt des CrypTool-Buchs}
