...
Kapitel \ref{Chapter_HomomorphicEnc} stellt {\bf Homomorphe Kryptofunktionen} vor:
Sie sind ein modernes Forschungsgebiet, das insbesonders im Zuge des Cloud-Computing
an Bedeutung gewann.
...
Die {\bf Anhänge} \ref{s:appendix-menu-overview-CT1},
\ref{s:appendix-template-overview-CT2} und \ref{s:appendix-function-overview-JCT}
...
\begin{itemize}
  \item dem \hyperlink{appendix-menu-overview-CT1}{Menübaum von CrypTool 1 (CT1)},
  \item den \hyperlink{appendix-template-overview-CT2}{Vorlagen in CrypTool 2 (CT2)},
  \item der \hyperlink{appendix-function-overview-JCT}
                      {Funktionsliste von JCrypTool (JCT)}, und
  \item der \hyperlink{appendix-function-overview-CTO}{Funktionsliste von CrypTool-Online (CTO)}.
\end{itemize}
...
in der jeweiligen Firma und an den Universitäten Frankfurt, Gießen, Siegen,
