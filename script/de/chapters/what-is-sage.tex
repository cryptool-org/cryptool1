...
\noindent Sage kann man auf vielfältige Weise nutzen:
...
\noindent Einen schnellen Einsteig bieten z.B. die Referenzen in dieser Fußnote%
\footnote{%
...
\noindent Es gibt inzwischen viele PDF- und HTML-Dokumente über Sage, so dass wir als guten Startpunkt nur einige wenige nennen\footnote{%
...
- Ein fertiger Kryptographie-Kurs von David Kohel, der Sage nutzt, aus 2008:\\
...
\end{center}
Standardmäßig nutzt man die Sage-{\bf Kommandozeile} als Interface, wie im
...
Und schließlich kann man Sage-{\bf Notebooks}\footnote{%
