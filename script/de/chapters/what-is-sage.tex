...
\begin{itemize}
  ...
  \item Um sich schnell die Sage-Programmbeispiele in diesem Skript anzusehen, können Sie
    ...
    \end{itemize}
  \item Der Quellcode der Sage-Beispiele in diesem Script wird in Form von
        Sage-Programmdateien mit dem CrypTool-Setup-Programm ausgeliefert.
        Nach der Installation finden Sie diese im Unterverzeichnis \verb#sage# innerhalb des
