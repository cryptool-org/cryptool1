...
Kapitel \ref{PaP_Sage_samples} (\glqq \nameref{PaP_Sage_samples}\grqq) und in
...
nützliche Befehle: load() und attach()\footnote{%
...
auf der Kommandozeile eingetippt. Ein Unterschied mag sein, dass Ausgaben explizit
...
attach() nutzen. In unserem obigen Beispiel sieht das auf der Sage-Kommandozeile
...
\vspace{30pt}
\noindent Eine Versionsabfrage der aktuellen Sage-Umgebung kann man durchführen mit:
\texttt{version()}


\noindent Um sich schnell die Sage-Programmbeispiele in diesem Skript anzusehen, können Sie\\
- im Index nach \verb#Sage -> Programmbeispiele# schauen, oder\\
- sich im Anhang das \glqq \nameref{sc:List-of-Sage-Code-Examples}\grqq~ansehen.
