...
% TODO JOERG
% Ich habe noch kash3-2008-07-31.spkg nachinstalliert, dieses Paket wird für Frau Massierers ECC Notebooks benötigt.
}
...
# * Finite Fields:
    ...
    sage: (a^3+1)^13
      a^2
\end{Verbatim}
\caption{Some small general samples from different areas in mathematics}
\end{sagecode}
...
index at \verb#Sage -> Code examples# or have a look at the
