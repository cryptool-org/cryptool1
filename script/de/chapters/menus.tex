...
Alle Funktionen der {\bf Algorithmen-Perspektive} finden sich in der \glqq Algorithmen'' genannten Navigationsleiste (in dieser Perspektive ebenfalls rechts). Die Algorithmen-Perspektive enthält alle Detaileinstellungen der verschiedenen Algorithmen und bietet insbesondere auch Algorithmen aus dem Bereich des Post-Quantum-Computings\index{Post-Quantum-Computing}\index{PQC} an.
