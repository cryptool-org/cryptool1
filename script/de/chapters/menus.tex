...
CrypTool\index{CrypTool}-Version 1.4.30\footnote{%
  Von den Zukunftsversionen CrypTool 2 und JCrypTool im CrypTool-Projekt gibt
  es bisher nur (stabile) Betaversionen. Wenn es hier Releaseversionen gibt,
  werden im Skript die entsprechen Menüpfade und Menübäume ergänzt.
}.
