...
\caption{Gegenüberstellung des Aufwands der Operationen Sign und Verify bei
  RSA und Elliptischen Kurven (Quelle: Dr. J.
  Merkle, Elliptic Curve Cryptography Workshop, 2001)} 
\end{center}
\end{figure}
\vskip -30 pt
...
Bei der digitalen Signatur muss man differenzieren: f"ur die {\em Erstellung} einer digitalen Signatur ben"otigen
bei auf Elliptischen Kurven basierende Verfahren im Vergleich zu RSA nur gut ein
...
\caption{Prognose f"ur die Entwicklung der als sicher betrachteten
  Schl"ussell"ange f"ur RSA und Elliptische Kurven\vspace{1ex}} 
\end{center}
\end{figure}
\vskip -20 pt
