...
mit $p$ ($p$ prim) Elementen. Die Implementierung erfolgte in
...
- den "Published Worksheets" auf \url{http://www.sagenb.org/pub/} mit\\
- Elliptic Curve\\
...
\footnote{%
Wenn Sie Ihre eigene Sage-Ungebung selbst erstellten, müssen Sie (z.B. mit Sage 4.1)
das Package "kash3-2008-07-31.spkg" compilieren, weil es vom ECC-Notebook von Frau
Massierer benötigt wird.
}.

Dieses Notebook\footnote{%
Starten des Notebook in einem Browser: Enter "notebook()" auf der Sage Kommandozeile.
- In your browser you normally first have to login.\\
- Klickt man auf "Published" in der oberen rechten Ecke, seiht man die 8 Worksheets.\\
Sie sollten danach ihre eigenen lokalen (under Linux im HOME-Verzeichnis) Kopien
erstellen [Klick auf "Edit a copy" in der linken oberen Ecke).\\
- Manchmal ist es nötig, dass man zu Beginn in der linken oberen Ecke
  \glqq Action -> Evaluate all\grqq klickt.\\
- Manchmal enthält das Fenster viele (blaue) Fehlermeldungen. Das kann man normalerweise
  schnell lösen, indem man den kleinen \glqq \%hide\grqq-String anklickt: Danach sieht
  man den Code hinter der Grafik. Mit Shift-Enter kann man die Grafik neu erzeugen.
},\footnote{%
  Seit 2008 steht diess Tutorial auf
  ...
  - Benutzt werden auch die Fonts jsMath. Deshalb sollten diese für eine bessere
    Darstellung in ihrem Browser installiert sein.
    Nach der Installation dieser Fonts hat man das jsMath-Symbol am unteren Rand
    des Browsers. Klickt masn dieses Symbol an, erhält man die Download-page dieser
    TTIF-Fonts.
    Leider muss die Installation der Fonts an jedem PC erfolgen.
}
