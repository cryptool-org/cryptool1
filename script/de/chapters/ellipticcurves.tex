...
BSI-Empfehlung: \glqq Geeignete Kryptoalgorithmen'' vom 24. Oktober 2002.
...
\begin{itemize}
   \item Eine Gruppe ist eine nichtleere Menge $G$ mit einer Verknüpfung \glqq $\cdot$''. Die Menge $G$ ist unter der
...
Um einen \glqq Man-in-the-Middle''-Angriff zu verhindern, kann man auch hier wie schon in Kapitel \ref{Impersonalisierungsattacke} beschrieben, die übertragenen Werte $G,q,R_A,R_B$ digital signieren.
...
\footnote{%
CT1: Menü {\bf Digitale Signaturen/PKI \textbackslash{} Signaturdemo (Signaturerzeugung)},\\
JCT (Standard-Perspektive): Menü {\bf Visualisierungen \textbackslash{}
Elliptische Kurvem-Berechnungen}.
...
\begin{enumerate}
  ...
  \item Online-Tutorial über Elliptische Kurven der Firma
   ...
   \item Tutorial mit Java Applets -- Krypto-Verfahren basierend auf
        elliptischen Kurven, Diplomarbeit Thomas Laubrock, 1999,\\
