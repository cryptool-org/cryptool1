...
(Filipovics B. / Büger M. / Esslinger B. / Oyono R., April 2000,
 Updates: Dez. 2001, Juni 2002, März 2003, August 2009)
...
% -----------------------------------------------------------------------------
\section{Implementierung Elliptischer Kurven zu Lehrzwecken, Patentaspekte}
...
\footnote{%
Sage-Beispiele dazu finden sich z.B. unter:\\
- den \glqq Published Worksheets\grqq~auf \url{http://www.sagenb.org/pub/} mit\\
- Elliptic Curve: \url{http://www.sagenb.org/home/pub/606/} \\
- Elliptic Curve El Gamal: \url{http://www.sagenb.org/home/pub/104/} \\
- oder im \glqq Elliptic Curve Cryptography (ECC) Tutorial\grqq~\\
  \url{http://www.williamstein.org/simuw06/notes/notes/node12.html}
}.


Ein sehr ausführliches ECC-Tutorial, genannt \hyperlink{ec:Web-Link:Sage_Massierer}{ECC-Skript},
gibt es von Maike Massierer.
Diese interaktive Einführung in die Elliptische-Kurven-Kryptographie (ECC)
ist als Sage-Notebook aufgebaut%
\footnote{%
Wenn Sie eine eigene Sage-Umgebung erstellen, müssen Sie
das Package \glqq kash3-2008-07-31.spkg\grqq~compilieren (z.B. für Sage 4.1),
denn es wird vom ECC-Notebook von Frau Massierer benötigt.
}.

Dieses Notebook\footnote{%
Starten des Sage-Notebook in einem Browser: Eingabe von \glqq notebook()\grqq~
auf der Sage Kommandozeile.\\
- Dann muss man sich normalerweise im Browser erst einloggen.\\
- Klickt man auf \glqq Published\grqq~in der oberen rechten Ecke, sieht man die 8 Worksheets.\\
Sie sollten danach Ihre eigenen lokalen Kopien (unter Linux im HOME-Verzeichnis)
erstellen (Klick auf \glqq Edit a copy\grqq~in der linken oberen Ecke).\\
...
- Manchmal enthält das Fenster viele (blaue) Fehlermeldungen. Das kann man normalerweise
  ...
  - Dieses Tutorial benutzt die Fonts jsMath. Für eine bessere Darstellung sollten diese
    in Ihrem Browser installiert sein.
