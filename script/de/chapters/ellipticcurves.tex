...
Massierer\footnote{%
Anleitung zur Benutzung eines interaktiven Sage-Notebooks:\\

  \noindent\hangindent=6pt\makebox[6pt][l]{-}%
  Öffentliche Sage-Server wie
  ...
  \noindent\hangindent=6pt\makebox[6pt][l]{-}%
  Anlegen eines Accounts für ein Sage-Notebook unter \url{http://sagenb.org/register}
  ...
  nicht korrekt dargestellt sind oder Ihr Browser meldent, dass Fonts fehlen,
  ...
  \noindent\hangindent=6pt\makebox[6pt][l]{-}%
  Gemäß der Sage-Support-Newsgroup wird daran gearbeitet, ein System zu erstellen,
  dass @interact komplett außerhalb des Sage-Notebooks benutzt werden kann
