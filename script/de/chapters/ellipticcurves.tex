...
geführt, dass die ben"otigten Schl"ussell"angen mehrfach angehoben werden mussten (vergleiche Kapitel \ref{SecurityRSA}).
Bedenkt man, dass die meisten Chips auf Smartcards nicht in der Lage sind, l"angere Schl"ussel als
...
fort, so kann man von einer Entwicklung der ben"otigten Schl"ussell"angen wie in der folgenden Graphik ausgehen
(Quelle: Arjen Lebstra und Eric Verheul: 
\href{http://cryptosavvy.com/table.htm}{\tt http://cryptosavvy.com/table.htm}).
...
Bei der digitalen Signatur muss man differenzieren: f"ur die {\em Erstellung} einer digitalen Signatur ben"otigt
bei auf Elliptischen Kurven basierenden Verfahren im Vergleich zu RSA nur gut ein
Zehntel des Rechenaufwandes (66 zu 515 Multiplikationen). Betrachtet man die f"ur eine {\em Verifikation} durchzuf"uhrenden
...
muss und digitalen Signatur, nicht aber die Verifikation auf der Karte stattfindet, treten hier deutlich
die Vorteile Elliptischer Kurven zu Tage. Unter Effizienzgesichtspunkten sind Verfahren, die auf Elliptischen
...
sind. Um mit einer beliebigen auf Elliptischen Kurven basierenden Anwendung kommunizieren zu k"onnen, m"ussete man
...
Initiativen von IEEE (P1363), ASC (ANSI X9.62, X9.63), IOS/IEC sowie von RSA labs und Certicom. Im
