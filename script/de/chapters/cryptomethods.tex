...
\section{Chiffren und Kryptoanalyse für Lehrzwecke} \index{Cryptanalysis}

Verglichen mit den auf Mathematik beruhenden Public-Key-Verschlüsselungsverfahren
wie RSA, ist die Struktur von AES und den meisten anderen modernen symmetrischen
Verschlüsselungsverfahren sehr komplex und kann nicht so einfach wie RSA
erklärt werden.
...
Wie man Mini-AES benutzt ist ausführlich in der folgenden Sage Reference Page beschrieben:\\
