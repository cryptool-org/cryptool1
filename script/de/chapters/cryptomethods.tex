...
praktische Nachteile auf (der verwendete Schl"ussel muss zuf"allig gew"ahlt werden und genauso lang wie die zu
...
N"aheres zu den AES-Algorithmen finden Sie in der CrypTool-Online-Hilfe\index{CrypTool} unter den Stichw"ortern {\em AES} und auf den  {\em AES-Kandidaten} und {\em AES-Algorithmus Rijndael}.
...
Der AES bietet mit einer Mindestschl"ussell"ange von 128 Bit gegen Brute-Force-Angriffe auch auf l"angere Sicht gen"ugend Sicherheit -- es sei denn, es st"unden entsprechend leistungsf"ahige Quantencomputer zur Verf"ugung. Der AES war immun gegen alle bis dahin bekannten Verfahren, die vor allem auf statistischen "Uberlegungen beruhen und auf DES angewandt wurden: man konstruiert aus Geheim- und Klartextpaaren Ausdr"ucke, die sich nicht rein zuf"allig verhalten, sondern R"uckschl"usse auf den verwendeten Schl"ussel zulassen. Dazu waren aber unrealistische Mengen an abgeh"orten Daten n"otig.

Bei Kryptoverfahren bezeichnet man solche Kryptoanalyseverfahren als ''akademischen Erfolg'' oder als ''kryptoanalytischen Angriff'', da sie theoretisch schneller sind als das Durchprobieren aller Schl"ussel, das beim Brute-Force-Angriff verwendet wird. Im Fall des AES mit maximaler Schl"ussell"ange (256 bit) braucht die ersch"opfende Schl"usselsuche im Durchschnitt $2^{255}$ Verschl"usselungsoperationen. Ein kryptoanalytischer Angriff muss diesen Wert unterbieten. Als aktuell gerade noch praktikabel (z.B. f"ur einen Geheimdienst) gelten $2^{75}$ bis $2^{90}$ Verschl"usselungsoperationen.
...
\href{http://www.cryptosystem.net/aes}{\texttt{http://www.cryptosystem.net/aes}} und \\ 
\href{http://www.minrank.org/aes/}{\texttt{http://www.minrank.org/aes/}}

F"ur AES mit 256 w"are der Angriff ebenfalls viel besser als Brute-Force, 
aber noch weiter au"serhalb der Reichweite realisierbarer Rechenpower. 
Die Diskussion ist aber kontrovers: Don Coppersmith (einer der DES-Erfinder) 
...
\glqq Ver-/Entschl"usseln \textbackslash Hybrid-Demo'' eine Visualisierung
dieses Verfahrens: darin werden die einzelnen Schritte und ihre Abhängigkeiten
...
Hybridverfahren verwendet.\par \vskip + 3pt
...
Neben Informationen in der umfangreichen Fachliteratur und im Internet 
enth"alt auch die Online-Hilfe von CrypTool\index{CrypTool} sehr viele Details zu den 
...
\bibitem[Schmeh2001]{Schmeh2001}  \index{Schmeh 2001}
	...
	dpunkt.verlag, 2. akt. und erw. Auflage 2001. \\
        Sehr gut lesbares, hoch aktuelles und umfangreiches Buch "uber Kryptographie. 
	Geht auch auf die praktischen Probleme, wie Standardisierung oder 
...
\bibitem[Courtois2002]{Courtois2002}  \index{Courtois 2002}
	...
	Eine davon verschiedene "compact version" des ersten XSL-Angriffs wurde 
