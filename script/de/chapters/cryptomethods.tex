...
(Bernhard Esslinger, Mai 1999; Updates: Dez. 2001, Feb. 2003, Juni 2005, Juli 2007)
...
Schneier \cite{Schneier1996cm}. Grundsätz"-lich unterscheidet man zwischen
...
Die Mathematiker Courois und Pieprzyk \cite{Courtois2002} veröffentlichten 
...
Mehrfachverschlüsselung (cascade cipher)\index{Mehrfachverschlüsselung}
...
Für 256-AES wäre der Angriff ebenfalls viel besser als Brute-force
\index{Angriff!Brute-force}, aber auch noch weiter außerhalb der
...
AES gar keine Lösung \cite{Coppersmith2002}. Dann würde auch die Optimierung von 
...
zusammen. Getestet wurden rund 15 Trillionen Schlüssel, bis der
...
% --------------------------------------------------------------------------
\subsection[Asymmetrische Verschlüsselung] % Was zw. [..] kommt ins Inhaltsverzeichnis!
...
benannt wurde. Der RSA-Algorithmus wurde 1978 veröffentlicht. 
...
In beiden Fällen wird AES als symmetrisches Verfahren eingesetzt.
...
generierter Sitzungsschlüssel (session key)\index{Session Key}, der
nur für diese Nachricht verwendet wird. Anschließend wird dieser
Sitzungsschlüssel mit Hilfe des asymmetrischen Verfahrens
verschlüsselt und zusammen mit der Nachricht an den Empfänger
übertragen. Der Empfänger kann den Sitzungsschlüssel mit Hilfe
seines geheimen Schlüssels bestimmen und mit diesem dann die
Nachricht entschlüsseln. Auf diese Weise nutzt man das bequeme
Schlüsselmanagement \index{Schlüsselmanagement} asymmetrischer
Verfahren und kann trotzdem große Datenmengen schnell und effektiv mit
symmetrischen Verfahren verschlüsseln.
...
\bibitem[Lucks-DuD2002]{Lucks-DuD2002}  \index{Lucks 2002}
        ...
        {\em Neue Ergebnisse zur Sicherheit des Verschlüsselungsstandards
             AES}, 
        in DuD 12/2002.
...
\bibitem[Schmeh2007]{Schmeh2007}  \index{Schmeh 2007}
        Klaus Schmeh, \\
        {\em Kryptografie},\\ 
        dpunkt.verlag, 3. akt. und erw. Auflage 2007. \\
        Sehr gut lesbares, hoch aktuelles und umfangreiches Buch über 
	Kryptographie. 
