...
(Bernhard Esslinger, Jörg-Cornelius Schneider, Mai 1999; Updates: Dez. 2001, Feb. 2003, Juni 2005, Juli 2007, Jan. 2010, März 2013, März 2016)

\index{ZZZ0a-xxxxxxxxxxxxxxxx}
...
Viele moderne Verfahren (insbesondere Hashverfahren und symmetrische Verschlüsse-lungsverfahren) benutzen numerische Konstanten. Diese sollten nachvollziehbar sein und keine Hintertüren ermöglichen. Zahlen, die das erfüllen, nennt man im Englischen~\glqq Nichts-im-Ärmel\grqq-Zahlen: Nothing-up-my-sleeve number\index{Zahlen!Nothing-up-my-sleeve}\index{Zahlen!NNN}.%
\footnote{\url{http://en.wikipedia.org/wiki/Nothing_up_my_sleeve_number}}

\end{itemize}

\index{ZZZ4xxxxxxxxxxxxxxxx}
\index{Zufallxxxxxxxxxxxxxxxx}
\index{Zahlen!Nothing-up-my-sleeve}
\index{Zahlen!NNNxxxxxxxxxxxxxxxx}%TODOTODO_weder hier noch im item wurden die Begriffe in den Index geschrieben! Problem von TeXworks? 19.3.16  script-de.ind zu löschen brachte nichts, ebsowenig wie die explitie Änderung von script-de.tex und das Löschen aller Zwischen-Files script-de.*?
xxxxxxxxxxxy
...
\index{ZZZ6gd-xxxxxxxxxxxxxxxx}
(\glqq \nameref{Kapitel_PaperandPencil} \grqq )
\index{ZZZ6gc-xxxxxxxxxxxxxxxx}
in diesem Skript oder 
\index{ZZZ6gb-xxxxxxxxxxxxxxxx}
in \cite{cm:Nichols1996}. 
\index{ZZZ6ga-xxxxxxxxxxxxxxxx}
In diesem Unterkapitel wollen wir jedoch nur die moderneren symmetrischen
Verfahren betrachten.
\index{ZZZ6f-xxxxxxxxxxxxxxxx}
...
Das bekannteste symmetrische Verschlüsselungsverfahren ist der 
DES-Algorithmus.\index{DES} Der DES-Algorithmus ist eine Entwicklung von IBM 
...
Die Mathematiker Courtois und Pieprzyk \cite{cm:Courtois2002} veröffentlichten 
...
\noindent Der folgende Abschnitt enthält SageMath Source-Code, der sich auf den Inhalt des
