...
CrypTool-Online-Hilfe\index{CrypTool}
  \footnote{%
      ...
      f"hrt auf die Hilfeseiten: {\bf AES-Kandidaten}, 
      {\bf Der AES-Gewinner Rijndael} und {\bf AES-Algorithmus Rijndael}.
  }
.
...
Die Diskussion ist sehr kontrovers: Don Coppersmith (einer der DES-Erfinder) 
...
Pseudozufallzahlgeneratoren. Nur im Secude-Generators wird eine "echte" 
