...
Juni 2005, Juli 2007, Januar 2010, Juni 2012)

%\begin{Quotes-from-Books}  %xx
\begin{center}
\fbox{\parbox{15cm}{%
...
\end{center}
%\caption{Indisches Sprichwort 1}{Indisches Sprichwort 2}  %xx
%\end{Quotes-from-Books}  %xx
...
{Symmetrische Verschlüsselung\footnotemark}
  \footnotetext{% XXX dieses Prozent ist nötig, sonst startet die Fußnote mit einem Blank !
    Mit {\bf CrypTool 1}\index{CrypTool 1} können Sie über das Menü
    ...
    Mit {\bf CrypTool 2}\index{CrypTool 2} können Sie im Startcenter
    ...
    AES, DES, PRESENT, RC2, RC4, SDES, TEA, TripleDES, Twofish.

    In {\bf JCrypTool}\index{JCrypTool} stehen Ihnen die folgenden modernen
...
Sie z.B. in der CrypTool-1-Online-Hilfe\index{CrypTool 1}%
\footnote{%
...
haben, veranstaltet z.B. RSA Security
...
Cipher-Challenges\footnote{%
  Ein weites Spektrum einfacher und komplexer Krypto-Aufgaben bietet
  der Wettbewerb \glqq MysteryTwister C3\grqq: \url{http://www.mysterytwisterc3.org}.
  \index{Challenge}
...
\section{Kryptoanalyse und Chiffren für Lehrzwecke} \index{Kryptoanalyse}
