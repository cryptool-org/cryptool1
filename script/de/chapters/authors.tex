...
\item[\textrm{[Preston2007]}] \index{Preston 2007}
    ...
    darstellen, sondern der Output eines Bodenradargeräts mit dem Bild eines
    gut erhaltenen Tyrannosaurus Rex ist.
    ...
    kommt ins Spiel. Er erklärt: Waffen, die einmal erfunden wurden, wurden immer auch
    eingesetzt. Die Menscheit wird sich ausrotten, aber seine Aufgabe sei es, das möglichst
    weit hinauszuzögern. Als Leiter der Abteilung LS480 will er mit allen Mitteln
    verhindern, dass Terroristen Zugang zu neuen gefährlichen biologische Waffen erhalten.
...
\item[\textrm{[Juels2009]}] \index{Juels 2009}
    ...
    Hinter den Angriffen scheint ein geheimer Kult zu stehen, Anhänger von Pythagoras,
...
\item[\textrm{[Suarez2010]}] \index{Suarez 2010}
    Daniel Suarez, \\
    {\em Daemon (Orginaltitel: Daemon)}, rororo, 2010. \\
    ...
    aktuellen Forschungen wie denen von Google-X-Labs (Google-Brille, selbst-steuernde Autos,
    3-D-Drucker, ...) in einer plausiblen Geschichte vereint.
    ...
    verteilten Instanzen seiner Inkarnation. Kern ist ein MMORPG-Spiel (Massive Multiplayer
    Online Role-Playing Game), das stark an WoW erinnert. Auch hierin gibt es verschlüsselte
    Kommunikation, z.B. um die besten Spieler anzuwerben: m0wFG3PRCoJVTs7JcgBwsOXb3U7yPxBB
...
% Filme: Matrix, Tron, Suarez Freedom, ...
% Bücher: xxx, ...
...
\item[\textrm{[Dittert2011]}] \index{Dittert 2011}
    ...
    Kosmos-Verlag, 2011 \\
    Im Haus von Professor Mathewson wurde ein altes, handgefertigtes Buchs gestohlen.
