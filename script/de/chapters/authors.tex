...
in der Deutschen Bank und Professor an der Universität Siegen. E-Mail:
...
Mitautor des Kapitels ``Krypto 2020 --- Perspektiven für langfristige
...
\item[\textrm{[Doyle1905]}] \index{Doyle 1905}
    ...
    Slaney.
    Sherlock Holmes knackt die Geheimschrift mittels Häufigkeitsanalyse.\\
...
\item[\textrm{[Crichton1988]}] \index{Crichton 1988}
    ...
    ein im Buch vollständig abgedruckter Code, der von dem genialen Mathematiker 
    Harry entschlüsselt werden kann: ein einfacher spiralenförmiger Ersetzungscode.\\
...
\item[\textrm{[Baldacci1997]}] \index{Baldacci 1997}
    ...
    Seine Frau Sidney Archer versucht, den Grund seines plötzlichen Todes herauszufinden,
...
\item[\textrm{[Stephenson1999]}] \index{Stephenson 1999}
    ...
    Randy Waterhouse und die schöne Amy Shaftoe -- zusammentun. \\
...
\item[\textrm{[Isau2003]}] \index{Isau 2003}
    ...
    die vereinten Kräfte der Computergemeinschaft gelöst werden.\\
...
\item[\textrm{[Hill2009]}] \index{Hill 2009}
    ...
    London 2021: Die Firma SoftMark hat eine elektronische Währung entwickelt und etabliert,
    die durch einen nicht entschlüsselbaren Code allen Nutzern höchste Sicherheit garantiert.
    Der Erfinder und Firmengründer John Law, wegen seiner mathematischen Begabung auch der
    ...
    geht auch die Firma von John Law pleite. Außerdem wird die Steuerfahnderin Anna Moore
    auf ihn angesetzt.\\
...
\vskip +60 pt
\subsection{Für Kinder}

Die folgende Auflistung enthält Filme und Kinderbücher. Die Kinderbücher enthalten Sammlungen von einfachen
...
Abgebildet und beschrieben finden Sie viele dieser Buchtitelseiten auf der Webseite von Tobias Schrödel, der sich vor allem mit antiken Büchern zur Kryptographie beschäftigt:\\
...
wesentliche Rolle spielt oder wenn Sie weitere Bücher kennen, die
...
\cite{Buchmann2004} und \cite{Scheid2003}.
...
\bibitem[Scheid2003]{Scheid2003} \index{Scheid 2003}
    Harald Scheid, \\
