...
\newpage
%--------------------------------------------------------------------
\subsection{Knapsackproblem als Basis f"ur Public Key-Verfahren}
...
Im Jahre 2000 waren die Autoren der Ansicht, da"s Werte der
Gr"o"senordnung $ 100 $ bis $ 200 $ Dezimalstellen sicher sind. Sie sch"atzten,
...
k"onnte, dass mit einer teuren Konfiguration (z.B. im Bereich von 10 Millionen
US-Dollar) eine Zahl mit $150$ Dezimalstellen in etwa einem Jahr zerlegt
werden k"onnte und dass eine $200-$stellige Zahl noch f"ur eine sehr lange Zeit
unzerlegbar bleiben d"urfte, falls es zu keinem mathematischen Durchbruch kommt.
Dass es aber nicht doch schon morgen zu einem mathematischen Durchbruch kommt,
kann man nie ausschlie"sen.\\
Wie leicht man sich versch"atzen kann, zeigt die
...
Der aktuelle Rekord\index{Logarithmusproblem!Rekord} (Stand April 2007) f"ur die Berechnung des diskreten
Logarithmus wurde im Februar 2007 von der Gruppe Kleinjung, Franke und Bahr an
der Universit"at Bonn aufgestellt.\footnote{%
...
Index-Calculus) \index{General Number Field Sieve (GNFS)} durchgef"uhrt und
ben"otigte ca.~17 CPU-Jahre auf 3.2 GHz Xeon Maschinen.
