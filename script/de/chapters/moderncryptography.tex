...
Es wurden eine Reihe von Algorithmen für Public-Key-Verfahren vorgeschlagen. Einige davon erwiesen sich, obwohl sie zunächst vielversprechend erschienen, als polynomial \index{Polynom} lösbar. Der berühmteste durchgefallene Bewerber ist der von Ralph Merkle \cite{mc:Merkle1978} vorgeschlagen Knapsack mit Falltür.
...
Tabelle~\ref{dlogprocs} listet verschiedene Verfahren zur Berechung des diskreten Logarithmus \cite{mc:Stinson1995} und ihre Komplexität.
\begin{table}[ht]
\begin{center}
...
\noindent Enthält $ |G| $ eine \glqq dominanten\grqq {} Primteiler $ p ,$ so ist die Komplexität \index{Komplexität} des Logarithmenproblem ungefähr
\[ O(\sqrt{p}). \]
