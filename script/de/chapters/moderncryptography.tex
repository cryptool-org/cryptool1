...
\[ d_{T} (y) = y^d \mod N \]
\caption{RSA-Verfahren (auf dem Faktorisierungsproblem basierend)}
\label{rsaproc}
\end{cryptoprocedure}
...
Tabelle~\ref{dlogprocs} listet verschiedene Verfahren zur Berechung des diskreten Logarithmus \cite{Stinson1995} und ihre Komplexität.
\begin{table}[ht]
\begin{center}
...
\caption{Verallgemeinertes ElGamal Verfahren (auf dem diskreten Logarithmusproblem basierend)}
