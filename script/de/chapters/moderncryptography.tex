...
Derartige Fragen gehören zu den {\bf NP}-vollständige Problemen (nicht \index{Laufzeit!nicht polynomial NP} deterministisch polynomial\index{Polynom}), die aufwendig zu berechnen sind.\index{Knapsack}
...
\vskip +10 pt
\noindent Die Eulersche Phi-Funktion ist definiert duch:
...
\vskip +10 pt
\noindent Kein gemeinsamer Faktor bedeutet: Zwei natürliche Zahlen $ a $ und $ b $
sind teilerfremd\index{Zahlen!teilerfremd (co-prime)}, falls $ \ggt (a,b)=1. $

\vskip +10 pt
\noindent Für die Eulersche Phi-Funktion gilt:
\[
\phi(1)=1,~~ \phi(2)=1,~~
\phi(3)=2,~~ \phi(4)=2,~~ \phi(6)=2,~~ \phi(10)= 4,~~ \phi(15)=8.
\]

\noindent Zum Beispiel ist $ \phi (24)=8, $ weil
\[
|\{ x <24 : \ggt (x,24) =1 \}| =|\{1,5,7,11,13,17,19,23\}|.
\]


\noindent Tabelle~\ref{phi15} zeigt Werte von $ \phi(n)$ bis $25$.
...
Gesucht ist das eindeutige $ a \in \N $ mit $ 0 \leq a \leq |H| -1 $ und $ \beta = \alpha^{a}. $\\
...
\vskip +25pt
\noindent \hyperlink{Chapter_EllipticCurves}{Elliptische Kurven}{} (siehe Kapitel \ref{Chapter_EllipticCurves})
...
\noindent Alle Links wurden am 13.07.2016 überprüft.


%--------------------------------------------------------------------
%\newpage
%\chapter*{Web-Links}%------------- DEUTSCH --------------------
%
