...
\vspace{-12pt}
Ab dem Jahr 2000 wurde -- zusammen mit dem
CrypTool-1-Paket (CT1)\index{CrypTool 1} -- auch ein Skript ausgeliefert,
das die Mathematik einzelner Themen genauer, aber doch 
...
%       und Kurioses zu Primzahlen (siehe \ref{HT-Quaint-curious-Primes-usage}),
  ...
  \item das Kapitel über Homomorphe Verschlüsselung
        (siehe \ref{Chapter_HomomorphicCiphers}).
\end{itemize}

Seit das Skript dem CT1-Paket in Version 1.2.01 das erste Mal beigelegt
wurde, ist es mit fast jeder neuen Version von CT1 ebenfalls erweitert
...
\\
\\
Frankfurt und Siegen, Januar 2013
\par \vskip + 30pt


\noindent PS:\\
Wir würden uns freuen, wenn sich weitere Autoren finden, die fundierte
Artikel zu einem der folgenden Themen Riemannsche Zeta-Funktion, Hashverfahren,
Zufallszahlen und Design/Angriff auf Krypto-Protokolle (wie SSL) ergänzen
könnten.
