...
\vspace{-12pt}
Ab dem Jahr 2000 wurde -- zusammen mit dem CrypTool-1-Paket (CT1)\index{CrypTool 1} -- 
auch ein Skript ausgeliefert, das die Mathematik einzelner Themen genauer, aber doch 
...
überarbei"-tet, und etliche Themen ergänzt, korrigiert, oder auf den aktuellen
Stand gebracht, z.B.:
\vspace{-5pt}
\begin{itemize}
...
%	(Kap. \ref{xxxxBrute-force-gegen-Symmetr})\index{xxxxxxxxxxxxxxxx} und
  ...
  \item die Funktionsübersichten
        \hyperlink{appendix-template-overview-CT2}{zu CT2} und
        \hyperlink{appendix-function-overview-JCT}{zu JCT},
  \item weitere Sage-Skripte zu Kryptoverfahren, und die Einführung in das 
        Computer-Algebra-System (CAS) Sage (siehe Anhang \ref{s:appendix-using-sage}).
        Sage wird mehr und mehr zum Standard-Open-Source CAS,
        % Nguyen und Massierer (vgl. auch Kap.~\ref{ec:Sage_Massierer})
  \item der Abschnitt über die Goldbach-Vermutung
        (siehe \ref{L-GoldbachConjecture}),
  \item der Abschnitt über gemeinsame Primzahlen in real verwendeten RSA-Modulen,
        (siehe \ref{l:NumberTheory_Shared-Primesxxx}),xxxxxxxxxxxxxxxxxx
  \item der Abschnitt über RSA-Fixpunkte
        (siehe \ref{l:NumberTheory_Sage_Number-of-RSA-FixedPoints}), und
  \item das Kapitel über Homomorphe Verschlüsselung
        (siehe \ref{Chapter_HomomorphicEnc}).
\end{itemize}
...
% [\baselineskip]
% \nopagebreak
Frankfurt und Siegen, Oktober 2012
...
\noindent \textbf{Die Programme CrypTool 1\index{CrypTool 1},
  CrypTool 2\index{CrypTool 2} und JCrypTool\index{JCrypTool}}
...
\noindent \textbf{CrypTool-Online und MTC3\index{CTO}\index{MTC3}}

Die Webseite CrypTool-Online (CTO) (\url{http://www.cryptool-online.org}), auf
der man im Browser oder vom Smartphone kryptographische Verfahren ausprobieren
und anwenden kann, gehört ebenfalls zum CT-Projekt. Der Umfang von CTO
ist bei weitem nicht so groß wie der der Standalone-Programme CT1, CT2 und JCT.

Vom CT-Projekt wird auch der internationale Kryptographie-Wettbewerb
MysteryTwister C3 (MTC3) (\url{http://www.mysterytwisterc3.org}) getragen.
Hier findet man kryptographische Rätsel in vier verschiedenen Kategorien, eine
High-Score-Liste und ein moderiertes Forum. Inzwischen nehmen über 3300 aktive
...
Sage ist ein Open-Source CAS-Paket, mit dem sich die in diesem Skript erläuterten
mathematischen Verfahren leicht Schritt-für-Schritt programieren lassen.
\par \vskip + 15pt
...
Artikel zu einem der ff. Themen Hashverfahren, Zufallszahlen und Design/Angriff auf
Krypto-Protokolle (wie SSL) ergänzen könnten.
