...
% --------------------------------------------------------------------------
\newpage
%\addcontentsline{toc}{section}{Vorwort zur 7. Ausgabe des CrypTool-Skripts} % be_2006: So springt er auf S. 3 statt auf S. 9 !!
...
\vspace{-7pt}
\begin{itemize}
  \item die Suche nach den größten Primzahlen (verallgemeinerte
        Mersenne- und Fermatzahlen) \\
%        Mersenne- und Fermatzahlen, \glqq M-40\grqq) 
	(Kap. \ref{spezialzahlentypen}, \ref{RecordPrimes}),
  \item die Faktorisierung großer Zahlen (RSA-200)\index{RSA-200} 
        (Kap. \ref{RSA-200}),
...
%	(Kap. \ref{xxxxBrute-force-gegen-Symmetr})\index{xxxxxxxxxxxxxxxxxxxxx} und
  \item eine Auflistung, in welchen Filmen und Romanen Kryptographie eine
        ...
        und wo Primzahlen als Aufhänger benutzt wurden 
