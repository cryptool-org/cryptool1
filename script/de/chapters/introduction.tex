...
\vspace{-12pt}
Ab dem Jahr 2000 wurde mit dem CrypTool-1-Paket\index{CrypTool} auch ein
...
Funktionen in CrypTool 1 (CT1)\index{CrypTool 1.x} aufrufen kann 
...
%	(Kap. \ref{xxxxBrute-force-gegen-Symmetr})\index{xxxxxxxxxxxxxxxxxxxxx} und
  ...
  \item Neu hinzu gekommen sind z.B. der Absatz zu Benfords Gesetz und Primzahlen
        (Kap. \ref{primes:Benford-Law}), und der Anhang \ref{s:appendix-using-sage} über
	...
	Außerdem kamen dank Nguyen und Massierer etliche neue Code-Beispiele hinzu
...
Dieses Skript wird zusammen mit dem Open-Source-Programm CrypTool 1\index{CrypTool}
ausgeliefert.
...
breite Leserschaft darzu"-stellen -- ohne mathematisch unkorrekt zu werden. 
...
Inzwischen wird CrypTool\index{CrypTool} weltweit in Ausbildung und Lehre
eingesetzt und von mehreren Hochschulen mit weiterentwickelt.
\par \vskip + 15pt
...
\begin{list}{\textbullet}{\addtolength{\itemsep}{-0.5\baselineskip}}
   ...
   \item Mitarbeiter von Prof.\ Claudia Eckert, Prof.\ Johannes Buchmann,
