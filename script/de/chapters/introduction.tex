...
\vspace{-12pt}
Ab dem Jahr 2000 wurde mit dem CrypTool-1-Paket (CT1)\index{CrypTool 1} auch
...
In dieser Ausgabe des Skripts wurden die TeX-Sourcen des Dokuments komplett überarbei"-tet,
und etliche Themen ergänzt, korrigiert, oder auf den aktuellen Stand gebracht, z.B.:
\vspace{-5pt}
\begin{itemize}
...
%	(Kap. \ref{xxxxBrute-force-gegen-Symmetr})\index{xxxxxxxxxxxxxxxx} und
  ...
  \item der Abschnitt über RSA-Fixpunkte (siehe \ref{l:NumberTheory_Sage_Number-of-RSA-FixedPoints}), und
