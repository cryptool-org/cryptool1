...
\begin{itemize}
  \item die Suche nach den größten Primzahlen (Mersenne- und Fermatzahlen):
        \glqq M44\grqq~ oder
        die im März 2007 gefundene größte Nicht-Mersenne-Primzahl, die sich bei
        der Untersuchung der Sierpinsky-Zahlen ergab
	(Kap. \ref{spezialzahlentypen}, \ref{RecordPrimes};
         Tab. \ref{L_n_Largest_Kown-Primes}, 
         Seite \pageref{L_n_Largest_Kown-Primes}),
  \item die Faktorisierung großer Zahlen, wie (C307)\index{C307}
        (Kap. \ref{RSA-200}),
...
New in June 2007:
- Update for prime records: 1039th Mersenne number (C307)
- QC nötige Längen !
...
mit dessen Hilfe Sie unter einer einheitlichen Oberfläche
...
An dieser Stelle möchte ich explizit sieben Personen danken, 
