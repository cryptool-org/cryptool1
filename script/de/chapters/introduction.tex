...
\par \vskip + 10pt
\noindent Heilbronn/Siegen, August 2016 + Januar 2017
...
\begin{compactitem}
\item Updaten aller Informationen zu SageMath (Kap.~\ref{ec:Sage_Massierer} und Appendix) und Testen des Codes gegen das neueste SageMath (Version 7.x), sowohl von der Kommandozeile als auch mit dem SageMathCloud-Notebook.
...
wir das Backbone momentan mit modernster Webtechnologie neu designen, um ein
schnelles und konsistentes Look\&Feel zu haben.
\par \vskip + 15pt
...
\noindent Bernhard Esslinger
\par \vskip + 10pt
\noindent Heilbronn/Siegen, August 2016
