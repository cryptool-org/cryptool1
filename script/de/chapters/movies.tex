...
% \verb muss auf derselben Zeile enden.
\begin{Verbatim}%
...
Man sieht gut, wie wenig Code man mit Python\index{Python} oder Sage für solche Aufgaben benötigt.
...
\printbibliography[%
	...
	%heading=subbibintoc,%offb. eine ebene zu hoch;
