...
\item[\textrm{[Suarez2011]}] \index{Suarez 2011}
    ...
    Having laid all the groundwork in ``Daemon'', Suarez uses most of this book to use this
    ...
    potentates and the Daemon society, which also evolves further during the story.
    ...
    availability of the network. Its not far away from the parallel usage of modern
    technology integrated into our modern lives as a virtual world overlaying our real
    world.\\
