...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-------fonts, encoding etc.
\usepackage{fontspec}% für lualatex, statt fontec wie bei pdflatex
%\setmainfont[Path=/Library/Fonts]{STIXGeneral}
...
%   Copyright \textcopyright{} 1998--2019 Bernhard Esslinger and the    %% Geht beides.
