...
%\documentclass[a4paper,11pt,oneside,english,ngerman]{scrbook}
...
\setlength{\parskip}{2em plus .5em minus .5em}
\parindent0pt

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-------fonts, encoding etc.
\usepackage{fontspec}% für lualatex, statt fontenc wie bei pdflatex
%\setmainfont{STIX} %\usepackage{stix2}
%\usepackage[math-style=TeX]{unicode-math} mathe spinnt bei umstellung!
%z.B. approx wird ein anderes zeichen ...
\usepackage[utf8]{luainputenc} %n"otig f"ur ok umlaute in sidebar vom pdf
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%----graphik, farben
\usepackage{color}   %BERM2: added for bitciphers.tex
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-----layout, z.B. boxen, listen, linien
\raggedbottom
\pagestyle{headings}
...
%%%%%%%%%%%%%%%%%%%5%%%%%%%%%%%%%%%----------user-defined-commands,envir., counters etc.
...
\renewenvironment{proof}[1]{\textbf{Beweis #1} \\}{\hfill$\Box$\par}
\newenvironment{Beweis}[1]{\textbf{Beweis #1} \\}{\hfill$\Box$\par}
\newenvironment{example}[1]{\textbf{Beispiel#1}}{}
\newenvironment{remark}[1]{\textbf{Bemerkung#1}}{}
...
(\settimeformat{hhmmsstime}\currenttime)}
...
\vfill
}%ende titelseite, ende centering
