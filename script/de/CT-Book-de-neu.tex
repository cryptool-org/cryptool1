% $Id: CT-Book-de.tex 3935 2018-05-17 00:19:11Z esslinger $
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%------bibliographie
%\usepackage[style=alphabetic,backend=biber,refsection=chapter]{biblatex}
\usepackage[style=alphabetic,backend=biber]{biblatex}
%\defbibheading{subbibliography}{%
%	\section*{Literatur für Kapitel \thechapter}}
...
%16xxx \usepackage[pdftex]{graphicx} %% RAUS wegen Option clash for package graphicx.
% \usepackage{graphicx}
