...
% Tried to write the row number of the last row (table 3.2) into the header
% of the table. As each call make it ti increment, I need to do calculations.
...
\begingroup
  ...
  \clearpage\phantomsection  %be_2018-05-02: Taking \phantomsection away from here causes link in ToC to move to an earlier page.
