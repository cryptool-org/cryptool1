% $Id$
% !Mode:: "TeX:EN:US"    % Setting document mode and submode for WinEdt
% ............................................................................
%        MAIN or STARTING file for the CrypTool book
%
% Comments: - Add (lengthy) comments only into the German version!
%           - Add to the English version only comments which refer only to English.
%
% Schreibregelung / Syntax rules / Writing rules / Notation in English:
%         - Chapter/Section header with all nouns/verbs capitalized.
%         - All other headers (incl. Section/Subsection) in the normal
%           lower/upper case manner like sentences, but without dot at the end.
%         - Use American English instead of British English consistently.
%
% EN Orthography: - finite abelian group  --> "abelian" lower case.
%                 - a Boolean function --> till now always upper case [Boolean <--> abelian?]
%
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

% \documentclass[a4paper,11pt,oneside,english]{book}
% \documentclass[a4paper,11pt,oneside,USenglish,english]{book}
% caused the
% Package Babel Warning: The package option `english' should not be used
% (Babel)                with a more specific one (like `USenglish').
\documentclass[a4paper,11pt,oneside,ngerman,english]{book}  % ngerman used in reference.bib
\overfullrule=5pt
\usepackage[latin1]{inputenc}
\usepackage[final]{microtype}% Loaded just to avoid black boxes which appeared even without
                             % documentclass draft mode(see Todos-for-later #1 in CT-Book-de.text).
                             % Necessary only in EN to avoid black box e.g. at p 397
                             % at begin of chap 10.1.1  (and book had 554 instead of
                             % 552 pages, but 7760 kb instead of 7873 kB).
...
\selectbiblanguage{english} % E: causes bibtex to put in Bibliography: edition: "1" --> "1st"
...
\title{% Avoid empty lines between the title brackets
