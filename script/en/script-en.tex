...
%
% Orthography English: - finite abelian group  --> "abelian" klein.
%                      - a Boolean function --> bisher immer groß [passt das zu abelian?]
%
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
%%%NEWNEW \xxxdefaultbibliography{references} % Why only in English version?
%%%NEWNEW \xxxdefaultbibliographystyle{abbrv} % Why only in English version?
...
%16xxxxxxxxxxxxxxProbiere es erstmal ohne dies aus dlog.tex \usepackage{hyperref,cite,url} 
%%%              Bedeutung der Syntax? Im Deutschen nicht (mehr?) drin.
...
%%% \xxbibliographyunit[\chapter]
%%% \xxbibliography*{../de/references}
%%% \xxbibliographystyle*{plain}
...
%------------------------------------------------------------------------------
% Create two complete bibliographies with different style
%% \begin{bibunit}[plain]
\begin{bibunit}[babplain]
\nocite{*}
\renewcommand{\bibname}{References of All Chapters}
\putbib[../de/references]
\addcontentsline{toc}{chapter}{Bibliography with References from All Chapters}
\end{bibunit}


\begin{bibunit}[babalpha]
\nocite{*}
\renewcommand{\bibname}{All References (sorted by alpha)}
\putbib[../de/references]
\addcontentsline{toc}{chapter}{Bibliography of All Chapters (sorted by alpha)}
\end{bibunit}
