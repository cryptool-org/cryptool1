...
\chapter{Appendix}
    \begin{itemize}
      ...
      \item[4] \hyperlink{appendix-authors}{Bibliography of Movies and
      ...
      \item[7] \hyperlink{appendix-authors}{Authors of the CrypTool Script}
    \end{itemize}
  \newpage
...
\vspace{30pt}
\begin{itemize}
  \item All samples have been tested with Sage v 4.7 (release date 2011-05-23).
  \item The source code of the Sage samples in this script is delivered as
        ...
        them within the subdirectory \verb#sage# within the CrypTool-1
        directory:\\
