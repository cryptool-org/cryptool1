...
\floatname{ctsquotefloat}{Quote}   % ctsQuotes with centering
...
\author{ % Die Klammer zur Fontänderung funktioniert bei author nur einzeilig im Gegensatz zu title?!
        ...
        {\LARGE and the CrypTool Team, 1998-2013}\\[5pt]
...
GNU Free Documentation Licence.
    ...
    This also includes the code of the Sage samples in this document.
\end{quote}
...
\begin{itemize}
  \item The source code of the Sage samples in this script is delivered as
        ...
        the Sage samples within the subdirectory \verb#sage# in the
        following 4 files:\\
