...
asymmetrical {\em encryption}. A large section of the script is dedicated
to the fascinating topic of {\em prime numbers}. Using numerous examples,
the {\em elementary number theory} and {\em modular arithmetic} are
introduced and applied in an exemplary manner to the RSA procedure.
After this, one receives insight into the mathematical ideas behind
{\em modern cryptography}. 

%You will also obtain an overview of the
%mathematical ideas behind modern cryptography.

A further chapter is devoted to {\em digital signatures}, 
which are an essential component of e-business applications. 
The last chapter describes {\em elliptic curves}: they could be used
...
used -- trying to do it didactically as good as possible.
