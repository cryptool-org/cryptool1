...
% --------------------------------------------------------------------------
\section*{Preface to the 8th Edition of the CrypTool Script}
...
Again this edition of the script amended and updated some topics:
\vspace{-7pt}
\begin{itemize}
  \item the search for the largest prime numbers
        (Mersenne and Fermat primes, ``M44'') \\ 
	(chap. \ref{spezialzahlentypen}, \ref{RecordPrimes};
         table \ref{L_n_Largest_Kown-Primes}, 
         page \pageref{L_n_Largest_Kown-Primes}), 
  \item the factorisation of big numbers (``C307'')\index{C307} 
        (chap. \ref{C307}),
...
\end{itemize}
Newly added is chapter \ref{Chapter_Crypto2020} by Prof. Buchman et al.:
{\bf Krypto2020}.
