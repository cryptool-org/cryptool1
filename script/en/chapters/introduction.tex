...
In order to also enable developers/authors to work independently together 
the topics have been split up and for each topic an extra chapter was 
written readable on its own. The later editorial work in TeX added 
...
\begin{itemize}
  ...
  \item progress in cryptanalysis of the AES standard (chap. 1.1) and
  \item progress in brute-force attacks against symmetric algorithms (chap. 1.1).
\end{itemize}

Chapter 6 of this script was also enhanced: now we explain in more details how elliptic curves are defined over different number fields.
...
open source versions of CrypTool\index{CrypTool} (they will be delivered by the University of Darmstadt).
...
This script is delivered together with the program CrypTool\index{CrypTool}. \par \vskip + 3pt
