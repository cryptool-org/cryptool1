...
program (see menu tree in appendix A). 
% \hyperlink{appendix-menutree}{(see menu tree in appendix A).}
...
\begin{itemize}
  \item the search for the largest prime numbers (generalized Mersenne 
        and Fermat primes) \\ (chap. \ref{spezialzahlentypen}), 
  \item progress in number theory (``Primes in P'') (chap. \ref{PrimesinP}), 
  \item the factorisation of big numbers (TWIRL, RSA-160) 
