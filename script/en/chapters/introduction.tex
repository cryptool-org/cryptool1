...
%        (see chapter \ref{Chapter_HomomorphicCiphers}).
  ...
  \item the ``\nameref{Chapter_Dlog-FactoringDead}'' is completely new too
        (see chapter \ref{Chapter_Dlog-FactoringDead}). It's a fantastic
...
\par \vskip + 10pt
\noindent Heilbronn/Siegen (Germany), August 2016 + August 2017 + May 2018
...
\begin{compactitem}
   ...
   \item random numbers,
   \item format-preserving encryption, privacy-preserving cryptography,
   \item discussion of the security effect of different block modes,
...
\begin{compactitem}
   \item Update all information about SageMath (chap.~\ref{ec:Sage_Massierer}
      and appendix) and run the code against the newest SageMath (version 8.x) --
      both command line and SageMathCloud notebook. SageMath 8 is also
...
% --------------------------------------------------------------------------
% BE_2018-05-02: According to Brian Dunn's recommendation: \phantomsection and
%                \chapter* substituted by \chapter and setting/resetting secnumdepth.
%                This also allows to get rid of \addcontentsline
...
so we currently redesign the backbone and frontend system with modern
web technology to offer a fast, consistent, and responsive look\&feel.
\par \vskip + 15pt
...
\par \vskip + 25pt  % vskip: more than +15 to start SageMath the next page
...
Python\index{Python} language at your disposal.\\
...
\noindent Bernhard Esslinger
\par \vskip + 10pt
\noindent Heilbronn/Siegen (Germany), August 2017
