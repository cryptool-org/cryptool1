...
%        (chap. \ref{xxxxxxxxxBrute-force-gegen-Symmetr})\index{xxxxxxxxxxxxxxxx} and
  \item a list of movies or novels, in which cryptography or number theory 
...
every new version of CrypTool (1.2.02, 1.3.00, 1.3.02, 1.3.03, 1.3.04 and now
1.4.00).
...
Frankfurt (Germany), June 2006

New in May 2007:
- Update for prime records: M44, Sierpinsky, 1039th Mersenne number
- Update for discrete logarithm problem record
- further literature added
- bugfixes reported by readers - thanks.
- new chapter by Prof. Buchmann at al. about current topics in cryptographic
  research and a forecast about the long-term security of cryptographic schemes.
...
At this point I'd like to thank explicitly seven people who particularly 
