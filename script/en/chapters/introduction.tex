...
%        (chap. \ref{xxxxxxxxxBrute-force-gegen-Symmetr})\index{xxxxxxxxxxxxxxxx} and
  ...
  \item Newly added is the appendix \ref{s:appendix-using-sage} about using the
        ...
        with Sage code. Thanks to Nguyen and Massierer, a lot of new code samples
        could be added (see also chap.~\ref{ec:Sage_Massierer}).
\end{itemize}
