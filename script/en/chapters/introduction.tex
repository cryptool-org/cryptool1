...
(CT1)\index{CrypTool 1.x} package. It is designed to accompany the
...
The later editorial work in TeX added cross linkages between different sections and footnotes describing where you can find the according functions within
the CrypTool programs. The appendices \ref{s:appendix-menu-overview-CT1} etc. contain a complete overview
of\index{CrypTool 1.x}\index{CrypTool 2}\index{JCrypTool}
the \hyperlink{menu-overview-CT1}{CrypTool 1 menu tree},
the \hyperlink{template-overview-CT2}{CrypTool 2 templates} and
the \hyperlink{function-overview-JCT}{JavaCrypTool (JCT) functions}.
...
%        (chap. \ref{xxxxxxxxxBrute-force-gegen-Symmetr})\index{xxxxxxxxxx} and
  ...
  \item Newly added are the functions overviews 
        \hyperlink{template-overview-CT2}{for CT2} and
        \hyperlink{function-overview-JCT}{(for JCT},
        further Sage scripts for cryptography and the appendix
...
The script was delivered the first time with CrypTool\index{CrypTool} in
...
CrypTool 1\index{CrypTool 1.x} and the successor versions
