...
chapter \ref{Primes_Sage_samples} (``\nameref{Primes_Sage_samples}'') and in
...
\begin{itemize}
  ...
  \item The source code of the Sage samples in this script is delivered as
        ...
        After installing CrypTool 1.x \index{CrypTool 1.x} you find them
        within the subdirectory \verb#sage# within the CrypTool directory:\\
