...
Getting an impression, how big Sage is: After downloading the source of Sage 4.1,
it took around 5 h on an average Linux PC to compile the whole system including
...
on the command line as in the above example\footnote{%
  ...
  from this script, in order to enter it at the commandline, 
...
use the command attach(). This looks in our Sage session as
