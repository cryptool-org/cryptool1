...
\noindent You can get a quick impression of Sage e.g. with the references in this footnote\footnote{%
...
\noindent In the meantime there are lots of PDF and HTML documents about using Sage, so we name only a few of them as a good starting point\footnote{%
...
\end{center}
The default interface to Sage is {\bf command line} based, as shown in
...
use Sage {\bf notebooks}\footnote{%
