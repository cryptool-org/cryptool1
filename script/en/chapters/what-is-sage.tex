...
%
% TODO: Funktionierte, aber Tabelle weiter nach links!
%\begin{tabular}{@{}l@{ }p{0.9\textwidth}}
%- & aaa sajdfjsaldfj sldf jlksadflsajdlk lcvjlxjcvl jsaldf ljlfdsjsaldfl;sajfl;asjdfjxzcljlzxcjvljasd    sjfdlsajdfljsaldj sadf  sdf l xxx xx xxx xx xxx xx xxx xx xxx xx xxx xx xxx xxxxxxxxx\\
%- & aaa sajdfjsaldfj sldf jlksadflsajdlk lcvjlxjcvl jsaldf ljlfdsjsaldfl;sajfl;asjdfjxzcljlzxcjvljasd    sjfdlsajdfljsaldj sadf  sdf  xxx xx xxx xx xxx xx xxx xx xxx xx xxx xxxxxxxxl\\
%\end{tabular}

\noindent\hangindent=6pt\makebox[6pt][l]{-}abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc abc 
...
%
%\setlength{\parindent}{...}
%\blindtext\par % Umbruch mit hängendem Einzug
%\blindtext\\   % Umbruch ohne hängenden Einzug
%\blindtext
%
%#################################
...
\noindent To load this function into Sage (and do a syntax check at once), use \verb!load()! as follows:
...
Sage command line. A difference may be that output needs a print statement.}.
...
use the command \verb!attach()!. This looks in our Sage session as
follows (you also can apply \verb!attach()! directly after loading the script,
...
\vspace{30pt}
\noindent To get the version of your Sage environment:
\texttt{version()}


\noindent To move quickly to the Sage code examples in this script,\\
- either look in the index at \verb#Sage -> Code examples#,\\
- or have a look at the appendix ``\nameref{sc:List-of-Sage-Code-Examples}''.
