% $Id: 
% ..............................................................................
%             W H A T  I S  S A G E M A T H  ?
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

\newpage
\hypertarget{appendix-using-sage}{}
\section{Short Introduction into the CAS SageMath}
...
common interface, namely, a Python\index{Python}\footnote{%
...
- ``Library'': {\centering \url{http://www.sagemath.org/library.html}},\\
...
\noindent\hangindent=6pt\makebox[6pt][l]{-}Discussions
   ...
   % TODO: hängender Einzug und Leerzeile (TODO_LaTeX)
...
or the same newer (from 2015) at\\
...
\begin{center}
\url{http://sagecell.sagemath.org/} or\\
...
browser (Iceweasel, Firefox, IE, ...) is started e.g. with the URL \textit{http://localhost:8000}.
}
...
% ---------------------------------------------------------------------------
\newpage
\section*{Examples using the built-in mathematical functions in SageMath}

Here are a few little examples\footnote{%
The examples are from 2008 from a no more existing blog of Dr. Alasdair McAndrew.}
...
then SageMath first parses your script, writes it to another file called
``primroots.py'' (note the ``.py'' extension), adds all necessary variables
to ``primroots.py'' as well as writing any import statements to that file.
That way, your SageMath script is executed as if you had typed the definitions
in your script to the SageMath command line. An important difference is that
all output needs a \verb!print! statement.
