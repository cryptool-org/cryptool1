...
transformations. The overall cipher is called product algorithm or cacade cipher (somtimes depending whether the used keys are statistically dependent or not).\\
