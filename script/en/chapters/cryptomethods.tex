...
Before AES, the most well-known symmetric encryption procedure was the \index{DES} DES algorithm.
...
%\index{ZZZ6b-xxxxxxxxxxxxxxxx_Bsp aus CT2.1 ergaenzen}
...
sender randomly\footnote{%
   ...
   random numbers.\\
   Within CT1\index{CrypTool 1} you can check out
...
%   CT2 xxxxxxxxxxxx\index{ZZZ6c-xxxxxxxxxxxxxxxx_Bsp-Menue aus CT2 ergaenzen}\\
   CT2 xxxxxxxxxxxx\index{ZZZ6c-xxxxxxxxxxxxxxxx}\\
