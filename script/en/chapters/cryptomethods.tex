...
\bibitem[Schmeh2001]{Schmeh2001}  \index{Schmeh 2001}
        ...
        real existing software. This book is right now only available in German, but in autumn 2002 it will be 
	available in English too from the publisher John Wiley, probably with the title {\em Cryptography}.
\end{thebibliography}
