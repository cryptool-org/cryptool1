...
%         - Chapter header with all nouns/verbs-words capitalized.
...
{Symmetric encryption\footnotemark}
  \footnotetext{%
    With {\bf CrypTool 1}\index{CrypTool 1} you can execute the following modern
    ...
    With {\bf CrypTool 2}\index{CrypTool 2} you can execute the following modern
    ...
    In {\bf JCrypTool}\index{JCrypTool} you can execute the following modern
    symmetric encryption algorithms:\\ 
...
can be found i.e. within the online help of CrypTool 1\index{CrypTool 1}%
\footnote{%
...
Companies like RSA Security provide so-called cipher challenges in order
...
\section{Cryptanalysis and ciphers for educational purposes} \index{Cryptanalysis}
