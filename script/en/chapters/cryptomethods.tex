...
{Asymmetric encryption\footnotemark}
  \footnotetext{%
    ...
    With CT2\index{CrypTool 2} you can also perform asymmetic methods
    (using the templates under {\bf Cryptography \textbackslash{} Modern}).\\
    JCT\index{JCrypTool} offers asymmetic methods like RSA both within
...
this case, you simply%
\footnote{%
That this is also not trivial is explained e.g. in xxxx % [[[KES-Article-SharedPrimes__und__anderes-Chapter-hier]]]
. Besides the requirements
for the key generation it has to be considered hat nowadays also (public-key)
infrastructures are targets of attacks.
}%
