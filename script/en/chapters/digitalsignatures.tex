...
\item to perform a simulation, how digital signatures could be attacked 
      by a targeted search for hash value collisions\index{collisions}.
\end{list}
}.
...
In both cases the final signature procedure would include weaknesses.
...
SHA-1 \index{SHA-1} is a 160 bit hashfunction specified in FIPS 180-1, 
