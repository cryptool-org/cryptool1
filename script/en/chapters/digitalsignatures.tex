...
(Esslinger B. / Filipovics B. / Schneider J. / Koy H., Update: June 2002)
...
digital signatures: \\
using the submenus of the main menu ``Digital Signatures'' or \\
...
Hash functions are implemented within CrypTool\index{CrypTool} v1.3.04 at
several places: \\
using menu  ``Indiv. Procedures \textbackslash Hash'' you have the possibility
...
\item to test, how changes to a text change the according hah value and \\
...
All participants who want to \index{X.509} have a X.509 certificate verifying that their public
key belongs to a real person consult what is known as a
\index{Certification authority (CA)} certification authority (CA). They prove their identity to this
...
\bibitem[Schneier1996]{5Schneier1996} \index{Schneier 1996} 
    ...
    and Source Code in C, Wiley, 2nd edition, 1996.
        ...
        \bibitem[FIPS186]{FIPS186} U.S. Department of
