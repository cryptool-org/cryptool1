...
\index{RSA} \hypertarget{RSAVerfahren}{} As early as 1978, R. \index{Rivest Ronald} Rivest, \index{Shamir Adi} A. Shamir,  \index{Adleman Leonard} L. Adleman \cite{RSA1978} introduced 
...
\index{Key agreement (key exchange)!Diffie-Hellman} \index{Diffie Whitfield} The mechanisms and 
