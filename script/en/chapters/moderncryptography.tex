...
\addtocounter {footnote} {-1} % Each footnotemark increase the footnotecounter by 1.
                              % So if there are two, we have to lower it before the first usage.
...
% University of Bonn.
In February 2007, the group Kleinjung, Franke, and Bahr at University of Bonn
did the then record\index{logarithm problem!record} for calculating discrete logarithms.
They calculated the discrete logarithm modulo a 160 digit prime number $p$
and a generator $g$:
$$
\begin{array}{r@{\:}c@{\:}l}
