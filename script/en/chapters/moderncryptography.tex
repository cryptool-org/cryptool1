...
%\vskip +10 pt
{\bf RSA procedure} (based on the factorization problem).
\vskip +20 pt
...
\index{Rabin!public key procedure} is equivalent to breaking the factorization problem. 
...
%\vskip +10 pt
{\bf Rabin procedure} (based on the factorization problem).
\vskip +20 pt
...
%\vskip +10 pt
{\bf ElGamal procedure} (based on the factorization problem).
\vskip +20 pt
...
%\vskip +10 pt
{\bf Generalized ElGamal procedure} (based on the factorization problem).
\vskip +20 pt
