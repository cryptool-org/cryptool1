...
The biggest compound number currently factorised\index{factoring records} with elliptic curves is 
...
\begin{enumerate}
   ...
   \item \hypertarget{Lenstra2}{}
	 ...
	 {\texttt{http://www.loria.fr/\~{}zimmerma/records/ecmnet.html}} \\
         There, one finds literature to the topic factorisation with 
