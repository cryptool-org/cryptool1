...
Updates: Dec. 2001, June 2002, Mar. 2003, Nov. 2009)
...
\footnote{%
CT1: menu {\bf Digital Signatures/PKI \textbackslash{} Signature Demonstration (Signature Generation)},\\
JCT (default perspective): menu {\bf Visuals \textbackslash{} Elliptic Curve Calculations}.
...
Massierer\footnote{%
Instructions to use an interactive Sage notebook\index{Sage!Instructions interactive notebook}:\\
...
\begin{enumerate}
   ...
   \item Interactive introduction to elliptic curves and elliptic curve
        cryptography with Sage\index{Sage} 
