...
- Start the Sage notebook in a browser.
  ...
  \noindent\hangindent=6pt\makebox[6pt][l]{-}%
  Click in the above right corner on ``Published'', then you will see the 8 worksheets.

  \noindent\hangindent=6pt\makebox[6pt][l]{-}%
  Sometimes it's necessary at the beginning to click in the left upper corner on
  ...
  the TIFF fonts. We are sorry, that this installation has to be done at every
  PC where this notebook runs in a browser.
