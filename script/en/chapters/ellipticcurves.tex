...
- about Elliptic Curve El Gamal: \url{http://www.sagenb.org/home/pub/104/}, or at
  ...
  thw "Elliptic Curve Cryptography (ECC) Tutorial"\\
  \url{http://www.williamstein.org/simuw06/notes/notes/node12.html}

}.

\noindent There is an exhaustive, interactive ECC tutorial by Maike Massierer,
called \hyperlink{ec:Web-Link:Sage_Massierer}{ECC notebook}.
...
The ECC notebook of Mrs. Massierer needs the KASH3 library: Therefore e.g. with Sage 4.1
the package ``kash3-2008-07-31.spkg'' has to be compiled.
}.

The notebook of Massierer\footnote{%
If you log on at another public server like
\url{http://sage.mathematik.uni-siegen.de:8000/home/pub/45/} or
\url{http://www.sagenb.org/}, and if there the according worksheets are installed
as "Published Worksheets", you can proceed as follows:\\
- Start the Sage notebook in a browser.

  \noindent\hangindent=6pt\makebox[6pt][l]{-}%
  Click in the above right corner at ``Published'', then you will see the 8 worksheets.
  ...
  \noindent\hangindent=6pt\makebox[6pt][l]{-}%
  This tutorial uses the fonts from jsMath. They should be installed into your
  browser for a better layout.
  ...
  \noindent\hangindent=6pt\makebox[6pt][l]{-}%
  If you want to change one of the worksheets you should generate
  your own local copy (under Linux in your home area) by clicking
  ``Edit a copy'' in the left upper corner.
