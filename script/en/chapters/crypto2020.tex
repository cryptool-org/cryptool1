...
In 2000, Lenstra and Verheul developed an
extrapolation formula that is supposed to help us
forecast the security\index{Security!forecast}
one can achieve with RSA and
other important cryptographic schemes in the long
...
numbers of relevant size.  Recent announcements of
...
suggested by Sönke Maseberg~\cite{maseberg-thesis:2002}.
...
Technische Universität Darmstadt and its spin-off,
