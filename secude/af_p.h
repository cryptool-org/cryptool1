...
Boolean SEC_GLOBAL_FUNC_PREFIX SEC_API_CALLING_CONV aux_isTelekomHackSet SEC_PROTOTYPE_0();
...
#if defined(ICR1) || defined(ICR2)
int SEC_GLOBAL_FUNC_PREFIX SEC_API_CALLING_CONV security_syntaxes SEC_PROTOTYPE_0();


Certificate SEC_GLOBAL_FUNC_PREFIX * SEC_API_CALLING_CONV  quipuCert2secudeCert SEC_PROTOTYPE_1(
	
	struct certificate      * 	, quipu_cert

);

struct SEC_GLOBAL_FUNC_PREFIX SEC_API_CALLING_CONV certificate * secudeCert2quipuCert SEC_PROTOTYPE_1(
	
	Certificate      * 	, secude_cert

);

struct SEC_GLOBAL_FUNC_PREFIX SEC_API_CALLING_CONV certificate_list * secudeCPair2quipuCPair SEC_PROTOTYPE_1(
...
char SEC_GLOBAL_FUNC_PREFIX * SEC_API_CALLING_CONV  aux_sprint_PolicyConstraint SEC_PROTOTYPE_2(
...
RC SEC_GLOBAL_FUNC_PREFIX SEC_API_CALLING_CONV aux_fprint_PolicyConstraint SEC_PROTOTYPE_2(
...
RC SEC_GLOBAL_FUNC_PREFIX SEC_API_CALLING_CONV aux_print_PolicyConstraint SEC_PROTOTYPE_1(
...
int SEC_GLOBAL_FUNC_PREFIX SEC_API_CALLING_CONV aux_pstrcmp SEC_PROTOTYPE_2(
	...
	register OctetString	 *	, a,
	
	register OctetString	 *	, b

);

int SEC_GLOBAL_FUNC_PREFIX SEC_API_CALLING_CONV aux_lexequ SEC_PROTOTYPE_2(
	
	register OctetString	 *	, str1,
	
	register OctetString	 *	, str2
...
PolicyConstraint 
SEC_GLOBAL_FUNC_PREFIX * SEC_API_CALLING_CONV  aux_cpy_PolicyConstraint SEC_PROTOTYPE_1(
	PolicyConstraint	 *	, old
);
...
void SEC_GLOBAL_FUNC_PREFIX SEC_API_CALLING_CONV aux_free_PolicyConstraint SEC_PROTOTYPE_1(
	PolicyConstraint	**	, ptr
);
...
RC SEC_GLOBAL_FUNC_PREFIX SEC_API_CALLING_CONV www_get SEC_PROTOTYPE_2(
        PSE   , pse_handle,
...
ASN1_en_de_PROTO(PolicyConstraint)
extern ASN1info_type SEC_GLOBAL_FUNC_PREFIX SEC_GLOBAL_VAR_PREFIX ASN1info_PolicyConstraint;
