...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfCloseProfile(SsfProfileHandle *Handle);
...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfGetCertificate(SsfProfileHandle Handle,
...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfPutCertificate(SsfProfileHandle Handle,
			SsfCertHandle			Cert);
...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfRemoveCertificate(SsfProfileHandle Handle,
			SsfCertIdent	*		Identification);
...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfFreeCertificate(SsfCertHandle *Cert);
...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfGetOwnCertificate(SsfProfileHandle Handle,
			SsfCertHandle	*		Cert);
...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfGetCertificateList(SsfProfileHandle Handle,
...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfEnumCertificateList(SsfCertListHandle CertList,
								SsfCertHandle * Cert);
...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfFreeCertificateList(SsfCertListHandle* CertList);
...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfCerttoASN1(SsfCertHandle Cert,
...
/*															*/
/*----------------------------------------------------------*/
SAPRETURN APIENTRY SsfParseCertificate(SsfCertHandle Cert,
