...
#if defined(SEC_WINDOWS) || defined(SEC_WINDOWS_NT) || defined(AS_400)
#define fsync(f) /* NOP */
#endif /* defined(SEC_WINDOWS) || defined(SEC_WINDOWS_NT) */

/*         System V changes and defines.          */
/**************************************************/

#if defined(SYSV) || defined(AS_400)
...
#endif
#else
/* Windows NT: function is called _alloca() */
#ifdef SEC_WINDOWS_NT
...
#if defined(SEC_WINDOWS) || defined(SEC_WINDOWS_NT) || defined(SEC_MS_DOS_GNU)
#define UNLOCK_FILE(dbf) 
#define READLOCK_FILE(dbf) lock_val = 0
#define WRITELOCK_FILE(dbf) lock_val = 0
#endif  /* defined(SEC_WINDOWS) || defined(SEC_WINDOWS_NT) || defined(SEC_MS_DOS_GNU) */
