...
//////////////////////////////////////////////////////////////////
// PlotDoc.cpp : implementation of the CPlotDoc class
//
...
IMPLEMENT_DYNCREATE(CPlotDoc, CMyDocument)

BEGIN_MESSAGE_MAP(CPlotDoc, CMyDocument)
...
/////////////////////////////////////////////////////////////////////////////
// CPlotDoc construction/destruction
...
void CPlotDoc::Load_Values(CArchive& ar){
	char Buff1[255];
	char* pch1, * pch2;
...
void  CPlotDoc::x_axis_add(double x){
...
void  CPlotDoc::y_axis_add(double y, double y_inc){
	ValueType *anItem1, *anItem2, *anItem3;
	char buffer[255];
	int len, prec;
...
BOOL CPlotDoc::OnNewDocument() 
{
	...
	//return CMyDocument::OnNewDocument();
	return FALSE;
}

void CPlotDoc::OnPlotbar() 
{
...
void CPlotDoc::OnUpdatePlotbar(CCmdUI* pCmdUI) 
{
...
void CPlotDoc::OnUpdateGotoVater(CCmdUI* pCmdUI) 
{
	// TODO: Code für die Befehlsbehandlungsroutine zum Aktualisieren der Benutzeroberfläche hier einfügen
