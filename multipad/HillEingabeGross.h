...
public:
	...
	CHillEingabeGross(hill *hillkl, CWnd* pParent = NULL);   // Standardkonstruktor
	~CHillEingabeGross();

// Dialogfelddaten
	//{{AFX_DATA(CHillEingabeGross)
	enum { IDD = IDD_DIALOG_SCHLUESSEL_HILL_EINGABE_GROSS };
