...
CRsaEnc::CRsaEnc(CWnd* pParent /*=NULL*/)
	: CDialog(CRsaEnc::IDD, pParent)
{
	//{{AFX_DATA_INIT(CRsaEnc)
...
void CRsaEnc::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CRsaEnc, CDialog)
	//{{AFX_MSG_MAP(CRsaEnc)
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen für Nachrichten CRsaEnc 

BOOL CRsaEnc::OnInitDialog() 
{
...
void CRsaEnc::InitAsymKeyListBox(unsigned nLocalKeylistType)
{
...
void CRsaEnc::UpdateRowSel(int row) 
{
	int i;
	CString Text;
...
int CRsaEnc::GetSpecifRow(UINT mask)
{
...
void CRsaEnc::OnOK() 
{
	...
	else if (UserKeyId.GetLength() < 1)
	{
		...
		LoadString(AfxGetInstanceHandle(),IDS_STRING41428,pc_str,STR_LAENGE_STRING_TABLE);
...
void CRsaEnc::OnClickList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CRsaEnc::OnColumnclickList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CRsaEnc::OnKeydownList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CRsaEnc::OnItemclickList1(NMHDR* pNMHDR, LRESULT* pResult) 
{
