...
class CDlgSignVerif : public CDialog
{
// Konstruktion
public:
	CDlgSignVerif(CWnd* pParent = NULL);   // Standardkonstruktor
	CDlgSignVerif(char* sig_id, char* hash_id, CString sig_key,  CWnd* pParent = NULL);
	CDlgSignVerif::~CDlgSignVerif(); // Destruktor
...
// Dialogfelddaten
	//{{AFX_DATA(CDlgSignVerif)
	enum { IDD = IDD_DIALOG_SIGN_VERIF };
