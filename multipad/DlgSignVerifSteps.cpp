...
/////////////////////////////////////////////////////////////////////////////
// Dialogfeld CDlgSignVerifSteps 


CDlgSignVerifSteps::CDlgSignVerifSteps(OctetString *msgOcts, bool msgFromFile, CString fname,\
									   ...
									   BOOL duration,\
									   CWnd* pParent /*=NULL*/)
	: CDialog(CDlgSignVerifSteps::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgSignVerifSteps)
	m_TextMessage = _T("");
	m_TextSign = _T("");
	m_DataDisplay = _T("");
	m_TextVerifSteps = _T("");
...
void CDlgSignVerifSteps::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgSignVerifSteps)
...
BEGIN_MESSAGE_MAP(CDlgSignVerifSteps, CDialog)
	//{{AFX_MSG_MAP(CDlgSignVerifSteps)
...
int CDlgSignVerifSteps::ecssa_sign_verif_op_ac( /* in */ L_NUMBER *c,
			      L_NUMBER *d,
			      OctetString *M,
...
int CDlgSignVerifSteps::emsa1_encoding_operation(/*out*/ L_NUMBER *f,
		             /*in   */ OctetString *M,
		                         unsigned int l,
...
int CDlgSignVerifSteps::emsa1_verfication_operation(/* in */ L_NUMBER *f,
			           OctetString *M,
			           unsigned int l,
			           char *hash_id) /* "SHA-1" or "RIPEMD-160" */
{
...
/**********************************************************************************************************************/
int CDlgSignVerifSteps::ecFp_ecvp_dsa_ac( L_NUMBER *c, L_NUMBER *d, ecFp_point_ac_srcptr W, ecFp_curve_srcptr E, ecFp_point_ac_srcptr G, L_NUMBER *r,L_NUMBER *f)
{
...
int CDlgSignVerifSteps::ecFp_ecvp_nr_ac(L_NUMBER *c, L_NUMBER *d, ecFp_point_ac_srcptr W, ecFp_curve_srcptr E, ecFp_point_ac_srcptr G,L_NUMBER *r, L_NUMBER *f)
{
	L_NUMBER h[MAXLGTH];
	ecFp_point_ac_destptr P,temp_point;
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen für Nachrichten CDlgSignVerifSteps 

BOOL CDlgSignVerifSteps::OnInitDialog() 
{
...
int CDlgSignVerifSteps::UpdateSigEditBox()
{
	int err;
...
int CDlgSignVerifSteps::DsaDataStructToDsaDataStringStruct()
{
	int err = 0;
	char *fstr;
	char *hstr;
...
int CDlgSignVerifSteps::NrDataStructToNrDataStringStruct()
{
	int err = 0;
	char *Pxstr;
	char *Pystr;
...
int CDlgSignVerifSteps::UpdateDataDisplay()
{
	CString sp1 = (CString)" ";
	CString sp2 = (CString)"  ";
	CString nl = (CString)"\r\n";
...
void CDlgSignVerifSteps::SignatureInvalid()
{
	verifFinish = clock();
...
void CDlgSignVerifSteps::SignatureValid()
{
	verifFinish = clock();
	duration = (double)(verifFinish - verifStart) / CLOCKS_PER_SEC;
...
void CDlgSignVerifSteps::OnButtonContinue() 
{
...
void CDlgSignVerifSteps::OnRadioOktal() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
...
void CDlgSignVerifSteps::OnRadioDezimal() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
...
void CDlgSignVerifSteps::OnRadioHexadezimal() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
...
void CDlgSignVerifSteps::OnRadioOctets() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
