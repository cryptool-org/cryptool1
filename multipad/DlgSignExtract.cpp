...
CDlgSignExtract::CDlgSignExtract(char* infile_name, const char *title, CWnd* pParent /*= NULL*/)
	: CDialog(CDlgSignExtract::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgSignExtract)
	m_sigButtonGroup = -1;
	m_KeyInfo = _T("");
	m_Signature = _T("");
...
void CDlgSignExtract::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgSignExtract)
...
BEGIN_MESSAGE_MAP(CDlgSignExtract, CDialog)
	//{{AFX_MSG_MAP(CDlgSignExtract)
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen für Nachrichten CDlgSignExtract 

BOOL CDlgSignExtract::OnInitDialog() 
{
...
int CDlgSignExtract::UpdateSigEditBox()
{
	int err;
...
void CDlgSignExtract::OnRadioOctets() 
{
...
void CDlgSignExtract::OnRadioOktal() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
...
void CDlgSignExtract::OnRadioDezimal() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
...
void CDlgSignExtract::OnRadioHexadezimal() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
