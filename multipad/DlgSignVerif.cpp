...
/////////////////////////////////////////////////////////////////////////////
// Dialogfeld CDlgSignVerif 


CDlgSignVerif::CDlgSignVerif(char* sig_id, char* hash_id, CString sig_key, CWnd* pParent /*= NULL*/)
	: CDialog(CDlgSignVerif::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgSignVerif)
	m_SigVerfahren = -1;
	m_HashFunktion = -1;
	m_EditSigAlg = _T("");
	m_EditHashAlg = _T("");
	...
	sigAlg  = sig_id; // Nur bei EC Signaturen (ECSP-DSA und ECSP-NR) relevant, da damit
	                  ...
	                  // Dieser Parameter darf auch in CDlgSignVerif auch "falsch" sein,
...
void CDlgSignVerif::FreeEcMemory()
{
	// Speicher freigeben
...
void CDlgSignVerif::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgSignVerif)
...
BEGIN_MESSAGE_MAP(CDlgSignVerif, CDialog)
	//{{AFX_MSG_MAP(CDlgSignVerif)
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen für Nachrichten CDlgSignVerif 


BOOL CDlgSignVerif::OnInitDialog() 
{
...
bevor CDlgSignVerif initialisiert ist - das ist etwas verwirrend. Daher
...
gesuchten Schlüsselbezeichner nicht gibt. Siehe CDlgSignVerif::OnButtonSearchKey()
...
int CDlgSignVerif::FindRow( CString pattern)
{
	int i;
	bool match;
...
void CDlgSignVerif::InitAsymKeyListBox(unsigned nLocalKeylistType)
{
...
void CDlgSignVerif::UpdateRowSel(int row) 
{
	int i;
	CString Text;
...
void CDlgSignVerif::OnClickList2(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
int CDlgSignVerif::GetSpecifRow(UINT mask)
{
...
void CDlgSignVerif::OnKeydownList2(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CDlgSignVerif::OnItemclickList2(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CDlgSignVerif::OnColumnclickList2(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CDlgSignVerif::OnCheckDsaKey() 
{
...
void CDlgSignVerif::OnCheckEcKey() 
{
...
void CDlgSignVerif::OnCheckRsaKey() 
{
...
void CDlgSignVerif::OnButtonSearchKey() 
{
...
void CDlgSignVerif::OnRadioECDSA() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
	UpdateData(TRUE);
...
void CDlgSignVerif::OnRadioECNR() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
	UpdateData(TRUE);
...
void CDlgSignVerif::OnRadioSHA1() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
	UpdateData(TRUE);
...
void CDlgSignVerif::OnRadioRIPEMD() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
	UpdateData(TRUE);
...
void CDlgSignVerif::OnRadioAffineCoord() 
{
	UpdateData(TRUE);
	use_affine_coord = true;// TRUE:affine coordinates;FALSE:projective coordinate
}

void CDlgSignVerif::OnRadioProjectCoord() 
{
	UpdateData(TRUE);
	use_affine_coord = false;// TRUE:affine coordinates;FALSE:projective coordinate
}
