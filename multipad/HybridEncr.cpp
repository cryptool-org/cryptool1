...
CHybridEncr::CHybridEncr(CWnd* pParent /*=NULL*/)
	: CDialog(CHybridEncr::IDD, pParent)
{
	//{{AFX_DATA_INIT(CHybridEncr)
	m_strEdit = _T("");
	m_strTitle = _T("");
	//}}AFX_DATA_INIT
...
void CHybridEncr::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CHybridEncr, CDialog)
	//{{AFX_MSG_MAP(CHybridEncr)
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen für Nachrichten CHybridEncr 
BOOL CHybridEncr::OnInitDialog() 
{
...
void CHybridEncr::OnButton1TxtEinfuegen() 
{
	int DatGroesse=0;
	m_strEdit = "";
	m_strTitle = "";
...
void CHybridEncr::OnButtonGenSymKey() 
{
...
void CHybridEncr::OnButtonEncKeyAsym() 
{
	RSAEncrypt();
	UpdateData();
	m_strEdit4 = "";
...
void CHybridEncr::OnButtonShowAsymKey() 
{
	UpdateData(true);
	m_strEdit = "";
	m_strTitle = "";
...
void CHybridEncr::GetCertificateData(Certificate *Zert)
{

}

void CHybridEncr::OnButtonShowtxt() 
{
