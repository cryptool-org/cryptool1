...
/////////////////////////////////////////////////////////////////////////////
// Dialogfeld CHillSchluesselAusgabeGross 


CHillSchluesselAusgabeGross::CHillSchluesselAusgabeGross(CWnd* pParent /*=NULL*/)
	: CDialog(CHillSchluesselAusgabeGross::IDD, pParent)
{
	//{{AFX_DATA_INIT(CHillSchluesselAusgabeGross)
	m_Feld11 = _T("");
	m_Feld12 = _T("");
	m_Feld13 = _T("");
	m_Feld14 = _T("");
...
void CHillSchluesselAusgabeGross::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CHillSchluesselAusgabeGross)
...
BEGIN_MESSAGE_MAP(CHillSchluesselAusgabeGross, CDialog)
	//{{AFX_MSG_MAP(CHillSchluesselAusgabeGross)
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen für Nachrichten CHillSchluesselAusgabeGross 

void CHillSchluesselAusgabeGross::OnDecrypt() 
{
	UpdateData(TRUE);
...
BOOL CHillSchluesselAusgabeGross::OnInitDialog() 
{
...
void CHillSchluesselAusgabeGross::MatrixAnzeigen(square_matrix& mat, int dim, hill& hillklasse)
{
...
void CHillSchluesselAusgabeGross::OnVerschluesseln() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
	OnDecrypt();	
}

void CHillSchluesselAusgabeGross::OnEntschluesseln() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
	OnDecrypt();
}

void CHillSchluesselAusgabeGross::OnKopieren() 
{
	// TODO: Code für die Behandlungsroutine der Steuerelement-Benachrichtigung hier einfügen
...
void CHillSchluesselAusgabeGross::SchluesselAnzeigen(CString Key)
{
