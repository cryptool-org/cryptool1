...
class CDlgSignVerifSteps : public CDialog
{
// Konstruktion
public:
	CDlgSignVerifSteps(OctetString *msgOcts, bool msgFromFile, CString fname,\
...
// Dialogfelddaten
	//{{AFX_DATA(CDlgSignVerifSteps)
	enum { IDD = IDD_DIALOG_SHOW_VERIF_STEPS };
...
// Überschreibungen
	...
	//{{AFX_VIRTUAL(CDlgSignVerifSteps)
	protected:
