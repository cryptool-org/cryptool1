...
class CHillSchluesselAusgabeGross : public CDialog
{
// Konstruktion
public:
	...
	CHillSchluesselAusgabeGross(CWnd* pParent = NULL);   // Standardkonstruktor

// Dialogfelddaten
	//{{AFX_DATA(CHillSchluesselAusgabeGross)
	enum { IDD = IDD_DIALOG_SCHLUESSEL_HILL_ANGRIFF_GROSS };
...
// Überschreibungen
	...
	//{{AFX_VIRTUAL(CHillSchluesselAusgabeGross)
	protected:
...
protected:
	...
	//{{AFX_MSG(CHillSchluesselAusgabeGross)
