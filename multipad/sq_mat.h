...
public:
	...
	// Ein- und Ausgabe
	friend ostream& operator<< (ostream & os, const square_matrix &);
	friend istream& operator>> (istream & is, square_matrix &);
	...
	BOOL invert(square_matrix *) const;
	BOOL invert_adjunkten_verfahren(square_matrix *) const;
	BOOL invert_gauss_jordan(square_matrix *) const;
