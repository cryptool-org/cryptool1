...
square_matrix::square_matrix(int dimension, int alphabetgroesse)
{
	dim = dimension;
...
long square_matrix::convert_long (long zahl) const
{
	if (zahl < 0)
	{
...
void square_matrix::convert_mod ()
{
	for (int i=0; i<dim; i++)
	{
		for (int j=0; j<dim; j++)
...
long& square_matrix::operator() (int zeile, int spalte)
{
	return mat[zeile][spalte];
}
long square_matrix::operator() (int zeile, int spalte) const
{
	return mat[zeile][spalte];
}

// Dimension der Matrix zurueckgeben
int square_matrix::get_dim (void) const
{
	return dim;
}

// Modul zurueckgeben
int square_matrix::get_mod (void) const
{
	return modul;
}

// Feldbreite zurueckgeben
int square_matrix::get_feldbreite (void) const
{
	return feldbreite;
}

// Feldbreite zurueckgeben
int square_matrix::get_inverses_element (int element) const
{
...
ostream& operator<< (ostream &os, const square_matrix &m)
{
...
square_matrix& square_matrix::operator= (const square_matrix &m)
{
...
long square_matrix::determinante (int *zeilen,
                                  int *spalten,
                                  int laenge) const
{
	long det = 0;
...
BOOL square_matrix::invert(square_matrix *mat1) const
{
	// Matrix ausgeben
#ifdef _DEBUG
...
BOOL square_matrix::invert_gauss_jordan(square_matrix *mat1) const
{
...
void square_matrix::BerechneFaktoren(int i) const
{
...
BOOL square_matrix::invert_adjunkten_verfahren(square_matrix *mat1) const
{
...
BOOL square_matrix::zufaellige_invertierbare_matrix(void)
{
