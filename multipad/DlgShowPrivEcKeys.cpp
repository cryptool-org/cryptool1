...
CDlgShowPrivEcKeys::CDlgShowPrivEcKeys(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgShowPrivEcKeys::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgShowPrivEcKeys)
...
CDlgShowPrivEcKeys::CDlgShowPrivEcKeys(CString User, CString name, CString firstname, CString creattime, CString cID, EcDomParam_ac_ptr ecParam, CWnd* pParent /*=NULL*/)
	: CDialog(CDlgShowPrivEcKeys::IDD, pParent)
{
...
void CDlgShowPrivEcKeys::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgShowPrivEcKeys)
...
BEGIN_MESSAGE_MAP(CDlgShowPrivEcKeys, CDialog)
	//{{AFX_MSG_MAP(CDlgShowPrivEcKeys)
...
/////////////////////////////////////////////////////////////////////////////
// Behandlungsroutinen für Nachrichten CDlgShowPrivEcKeys 

void CDlgShowPrivEcKeys::OnOctalRadio() 
{
	base = 8;
...
void CDlgShowPrivEcKeys::OnDecimalRadio() 
{
	base = 10;
	int error = EcDomParamAcToString(&ecParamString, curveParameter, base);
	if (error > 0)
...
void CDlgShowPrivEcKeys::OnHexRadio() 
{
	base = 16;
	int error = EcDomParamAcToString(&ecParamString, curveParameter, base);
	if (error > 0)
...
void CDlgShowPrivEcKeys::UpdateEcListBox()
{
...
BOOL CDlgShowPrivEcKeys::OnInitDialog() 
{
...
void CDlgShowPrivEcKeys::OnCancel() 
{
